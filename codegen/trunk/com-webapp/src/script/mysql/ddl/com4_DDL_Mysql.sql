...
(
	SRCHWRD_MANAGE_ID     CHAR(20) NULL,
...
(
	CNTC_MSSAGE_ID        VARCHAR(20) NULL,
...
(
	...
	FOREIGN KEY COMTNWIKIBKMK_FK1 (USER_ID) REFERENCES COMTNTWITTER(USER_ID)
)
;
