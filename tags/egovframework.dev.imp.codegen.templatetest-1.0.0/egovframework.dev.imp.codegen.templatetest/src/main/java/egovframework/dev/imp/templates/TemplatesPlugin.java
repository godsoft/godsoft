package egovframework.dev.imp.templates;

import org.eclipse.ui.plugin.AbstractUIPlugin;
import org.osgi.framework.BundleContext;

/**
 * 템플릿 기반 코드젠에 사용할 템플릿 테스트 플러그인 
...
public class TemplatesPlugin extends AbstractUIPlugin {
	...
	// 플러그인 ID
	public static final String PLUGIN_ID = "egovframework.dev.imp.templates";
