...
public class Globals {
	...
	public static final String PATH_WEBAPP = EgovProperties.getProperty("Globals.path.webapp");
	public static final String PATH_WEB = EgovProperties.getProperty("Globals.path.web");
	public static final String PATH_VENDOR = EgovProperties.getProperty("Globals.path.vendor");
