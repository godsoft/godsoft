...
public class ComtnbannerController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnbannerDefaultVO
	 * @return "/comtnbanner/ComtnbannerList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnbanner/ComtnbannerList.do")
    public String selectComtnbannerList(@ModelAttribute("searchVO") ComtnbannerDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnbannerList = comtnbannerService.selectComtnbannerList(searchVO);
