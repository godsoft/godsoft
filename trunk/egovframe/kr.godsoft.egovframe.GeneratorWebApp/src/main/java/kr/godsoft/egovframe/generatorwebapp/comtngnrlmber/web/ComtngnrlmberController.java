...
@Controller
@SessionAttributes(types=ComtngnrlmberVO.class)
public class ComtngnrlmberController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtngnrlmberDefaultVO
	 * @return "/comtngnrlmber/ComtngnrlmberList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtngnrlmber/ComtngnrlmberList.do")
    public String selectComtngnrlmberList(@ModelAttribute("searchVO") ComtngnrlmberDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtngnrlmberList = comtngnrlmberService.selectComtngnrlmberList(searchVO);
