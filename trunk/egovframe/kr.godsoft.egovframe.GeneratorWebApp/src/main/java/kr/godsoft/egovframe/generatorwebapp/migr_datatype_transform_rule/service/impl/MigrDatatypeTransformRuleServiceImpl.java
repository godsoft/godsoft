...
/**
 * @Class Name : MigrDatatypeTransformRuleServiceImpl.java
 * @Description : MigrDatatypeTransformRule Business Implement class
...
@Service("migrDatatypeTransformRuleService")
public class MigrDatatypeTransformRuleServiceImpl extends AbstractServiceImpl implements
        MigrDatatypeTransformRuleService {

    @Resource(name="migrDatatypeTransformRuleDAO")
    private MigrDatatypeTransformRuleDAO migrDatatypeTransformRuleDAO;
    
    /** ID Generation */
    //@Resource(name="{egovMigrDatatypeTransformRuleIdGnrService}")    
    ...
    public String insertMigrDatatypeTransformRule(MigrDatatypeTransformRuleVO vo) throws Exception {
    	...
    	migrDatatypeTransformRuleDAO.insertMigrDatatypeTransformRule(vo);
    ...
    public void updateMigrDatatypeTransformRule(MigrDatatypeTransformRuleVO vo) throws Exception {
        migrDatatypeTransformRuleDAO.updateMigrDatatypeTransformRule(vo);
    }
    ...
    public void deleteMigrDatatypeTransformRule(MigrDatatypeTransformRuleVO vo) throws Exception {
        migrDatatypeTransformRuleDAO.deleteMigrDatatypeTransformRule(vo);
    }
    ...
    public MigrDatatypeTransformRuleVO selectMigrDatatypeTransformRule(MigrDatatypeTransformRuleVO vo) throws Exception {
        MigrDatatypeTransformRuleVO resultVO = migrDatatypeTransformRuleDAO.selectMigrDatatypeTransformRule(vo);
        if (resultVO == null)
    ...
    public List<EgovMap> selectMigrDatatypeTransformRuleList(MigrDatatypeTransformRuleVO vo) throws Exception {
        return migrDatatypeTransformRuleDAO.selectMigrDatatypeTransformRuleList(vo);
    }
    ...
    public int selectMigrDatatypeTransformRuleListTotCnt(MigrDatatypeTransformRuleVO vo) {
		return migrDatatypeTransformRuleDAO.selectMigrDatatypeTransformRuleListTotCnt(vo);
	}
