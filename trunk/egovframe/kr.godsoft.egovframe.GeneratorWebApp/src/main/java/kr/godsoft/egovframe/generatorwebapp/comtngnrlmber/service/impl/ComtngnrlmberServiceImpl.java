...
import kr.godsoft.egovframe.generatorwebapp.comtngnrlmber.service.impl.ComtngnrlmberDAO;
...
public class ComtngnrlmberServiceImpl extends AbstractServiceImpl implements
	 ...
	 * @exception Exception
	 */
    public List selectComtngnrlmberList(ComtngnrlmberDefaultVO searchVO) throws Exception {
        return comtngnrlmberDAO.selectComtngnrlmberList(searchVO);
    }
	 ...
	 * @exception
	 */
    public int selectComtngnrlmberListTotCnt(ComtngnrlmberDefaultVO searchVO) {
		return comtngnrlmberDAO.selectComtngnrlmberListTotCnt(searchVO);
	}
