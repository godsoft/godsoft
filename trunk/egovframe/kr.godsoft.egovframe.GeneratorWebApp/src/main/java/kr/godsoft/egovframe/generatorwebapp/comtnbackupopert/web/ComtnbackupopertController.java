...
@Controller
@SessionAttributes(types=ComtnbackupopertVO.class)
public class ComtnbackupopertController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnbackupopertDefaultVO
	 * @return "/comtnbackupopert/ComtnbackupopertList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnbackupopert/ComtnbackupopertList.do")
    public String selectComtnbackupopertList(@ModelAttribute("searchVO") ComtnbackupopertDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnbackupopertList = comtnbackupopertService.selectComtnbackupopertList(searchVO);
