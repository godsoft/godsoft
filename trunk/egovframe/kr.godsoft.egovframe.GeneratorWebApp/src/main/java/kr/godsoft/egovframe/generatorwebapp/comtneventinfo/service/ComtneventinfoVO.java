...
/**
 * @Class Name : ComtneventinfoVO.java
 * @Description : Comtneventinfo VO class
...
public class ComtneventinfoVO extends ComtneventinfoDefaultVO {
    ...
    public String getEventSvcBgnde() {
        return this.eventSvcBgnde;
    }
    
    public void setEventSvcBgnde(String eventSvcBgnde) {
