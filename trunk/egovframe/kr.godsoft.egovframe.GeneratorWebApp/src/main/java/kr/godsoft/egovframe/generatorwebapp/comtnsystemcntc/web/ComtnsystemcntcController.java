...
public class ComtnsystemcntcController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnsystemcntcVO
	 * @return "/comtnsystemcntc/ComtnsystemcntcList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnsystemcntc/ComtnsystemcntcList.do")
    public String selectComtnsystemcntcList(@ModelAttribute("searchVO") ComtnsystemcntcVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List<EgovMap> comtnsystemcntcList = comtnsystemcntcService.selectComtnsystemcntcList(searchVO);
