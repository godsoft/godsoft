...
public class ComtnnoteDAO extends EgovAbstractDAO {
    ...
    public List selectComtnnoteList(ComtnnoteDefaultVO searchVO) throws Exception {
        return list("comtnnoteDAO.selectComtnnoteList_D", searchVO);
    }
    ...
    public int selectComtnnoteListTotCnt(ComtnnoteDefaultVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("comtnnoteDAO.selectComtnnoteListTotCnt_S", searchVO);
    }
