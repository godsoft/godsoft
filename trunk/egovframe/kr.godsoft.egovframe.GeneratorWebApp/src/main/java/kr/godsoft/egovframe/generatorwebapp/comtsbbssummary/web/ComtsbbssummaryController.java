...
@Controller
@SessionAttributes(types=ComtsbbssummaryVO.class)
public class ComtsbbssummaryController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtsbbssummaryDefaultVO
	 * @return "/comtsbbssummary/ComtsbbssummaryList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtsbbssummary/ComtsbbssummaryList.do")
    public String selectComtsbbssummaryList(@ModelAttribute("searchVO") ComtsbbssummaryDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtsbbssummaryList = comtsbbssummaryService.selectComtsbbssummaryList(searchVO);
