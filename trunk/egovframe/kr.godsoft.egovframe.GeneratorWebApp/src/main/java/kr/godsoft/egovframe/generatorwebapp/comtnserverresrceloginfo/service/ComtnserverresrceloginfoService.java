...
public interface ComtnserverresrceloginfoService {
	 ...
	 * @exception Exception
	 */
    List selectComtnserverresrceloginfoList(ComtnserverresrceloginfoDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtnserverresrceloginfoListTotCnt(ComtnserverresrceloginfoDefaultVO searchVO);
