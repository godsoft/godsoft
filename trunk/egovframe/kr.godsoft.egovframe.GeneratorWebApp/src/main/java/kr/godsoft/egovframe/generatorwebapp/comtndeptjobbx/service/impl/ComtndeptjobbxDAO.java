...
public class ComtndeptjobbxDAO extends EgovAbstractDAO {
    ...
    public List selectComtndeptjobbxList(ComtndeptjobbxDefaultVO searchVO) throws Exception {
        return list("comtndeptjobbxDAO.selectComtndeptjobbxList_D", searchVO);
    }
    ...
    public int selectComtndeptjobbxListTotCnt(ComtndeptjobbxDefaultVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("comtndeptjobbxDAO.selectComtndeptjobbxListTotCnt_S", searchVO);
    }
