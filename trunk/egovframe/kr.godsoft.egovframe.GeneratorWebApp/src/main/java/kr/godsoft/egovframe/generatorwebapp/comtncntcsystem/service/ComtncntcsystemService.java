...
public interface ComtncntcsystemService {
	 ...
	 * @exception Exception
	 */
    List selectComtncntcsystemList(ComtncntcsystemDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtncntcsystemListTotCnt(ComtncntcsystemDefaultVO searchVO);
