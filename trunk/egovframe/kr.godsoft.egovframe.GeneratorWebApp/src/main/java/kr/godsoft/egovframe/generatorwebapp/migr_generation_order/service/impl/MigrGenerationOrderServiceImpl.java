...
public class MigrGenerationOrderServiceImpl extends AbstractServiceImpl implements
        MigrGenerationOrderService {

    @Resource(name="migrGenerationOrderDAO")
    private MigrGenerationOrderDAO migrGenerationOrderDAO;
    
    /** ID Generation */
    //@Resource(name="{egovMigrGenerationOrderIdGnrService}")    
