...
public class ComtnauthorrolerelateController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnauthorrolerelateVO
    ...
    public String selectComtnauthorrolerelateList(@ModelAttribute("searchVO") ComtnauthorrolerelateVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List<EgovMap> comtnauthorrolerelateList = comtnauthorrolerelateService.selectComtnauthorrolerelateList(searchVO);
