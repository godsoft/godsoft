...
@Controller
@SessionAttributes(types=ComtnentrprsmberVO.class)
public class ComtnentrprsmberController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnentrprsmberDefaultVO
	 * @return "/comtnentrprsmber/ComtnentrprsmberList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnentrprsmber/ComtnentrprsmberList.do")
    public String selectComtnentrprsmberList(@ModelAttribute("searchVO") ComtnentrprsmberDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnentrprsmberList = comtnentrprsmberService.selectComtnentrprsmberList(searchVO);
