...
public class ComtncpyrhtinfoController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtncpyrhtinfoVO
	 * @return "/comtncpyrhtinfo/ComtncpyrhtinfoList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtncpyrhtinfo/ComtncpyrhtinfoList.do")
    public String selectComtncpyrhtinfoList(@ModelAttribute("searchVO") ComtncpyrhtinfoVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List<EgovMap> comtncpyrhtinfoList = comtncpyrhtinfoService.selectComtncpyrhtinfoList(searchVO);
