...
public interface ComtnleadersttusService {
	 ...
	 * @exception Exception
	 */
    List selectComtnleadersttusList(ComtnleadersttusDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtnleadersttusListTotCnt(ComtnleadersttusDefaultVO searchVO);
