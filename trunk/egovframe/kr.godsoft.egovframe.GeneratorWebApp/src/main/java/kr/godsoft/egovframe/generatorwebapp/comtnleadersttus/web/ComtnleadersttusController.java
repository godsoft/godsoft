...
@Controller
@SessionAttributes(types=ComtnleadersttusVO.class)
public class ComtnleadersttusController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnleadersttusDefaultVO
	 * @return "/comtnleadersttus/ComtnleadersttusList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnleadersttus/ComtnleadersttusList.do")
    public String selectComtnleadersttusList(@ModelAttribute("searchVO") ComtnleadersttusDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnleadersttusList = comtnleadersttusService.selectComtnleadersttusList(searchVO);
