...
public class ComtnnoteController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnnoteDefaultVO
	 * @return "/comtnnote/ComtnnoteList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnnote/ComtnnoteList.do")
    public String selectComtnnoteList(@ModelAttribute("searchVO") ComtnnoteDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnnoteList = comtnnoteService.selectComtnnoteList(searchVO);
