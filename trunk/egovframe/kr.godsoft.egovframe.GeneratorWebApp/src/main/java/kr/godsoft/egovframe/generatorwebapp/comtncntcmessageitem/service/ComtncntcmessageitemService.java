...
public interface ComtncntcmessageitemService {
	 ...
	 * @exception Exception
	 */
    List selectComtncntcmessageitemList(ComtncntcmessageitemDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtncntcmessageitemListTotCnt(ComtncntcmessageitemDefaultVO searchVO);
