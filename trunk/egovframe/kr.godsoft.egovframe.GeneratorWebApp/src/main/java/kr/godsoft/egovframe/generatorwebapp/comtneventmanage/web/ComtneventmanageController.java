...
@Controller
@SessionAttributes(types=ComtneventmanageVO.class)
public class ComtneventmanageController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtneventmanageDefaultVO
	 * @return "/comtneventmanage/ComtneventmanageList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtneventmanage/ComtneventmanageList.do")
    public String selectComtneventmanageList(@ModelAttribute("searchVO") ComtneventmanageDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtneventmanageList = comtneventmanageService.selectComtneventmanageList(searchVO);
