...
public class MigrDatatypeTransformRuleController {
    ...
    public String selectMigrDatatypeTransformRuleList(@ModelAttribute("searchVO") MigrDatatypeTransformRuleVO searchVO, 
    		ModelMap model)
            throws Exception {
    ...
    public String addMigrDatatypeTransformRuleView(
            @ModelAttribute("searchVO") MigrDatatypeTransformRuleDefaultVO searchVO, Model model)
            throws Exception {
    ...
    public String addMigrDatatypeTransformRule(
            MigrDatatypeTransformRuleVO migrDatatypeTransformRuleVO,
            @ModelAttribute("searchVO") MigrDatatypeTransformRuleDefaultVO searchVO, SessionStatus status)
            throws Exception {
    ...
    public String updateMigrDatatypeTransformRuleView(
...
;        
        // 변수명은 CoC 에 따라 migrDatatypeTransformRuleVO
    ...
    public @ModelAttribute("migrDatatypeTransformRuleVO")
    MigrDatatypeTransformRuleVO selectMigrDatatypeTransformRule(
            MigrDatatypeTransformRuleVO migrDatatypeTransformRuleVO,
            @ModelAttribute("searchVO") MigrDatatypeTransformRuleDefaultVO searchVO) throws Exception {
    ...
    public String updateMigrDatatypeTransformRule(
            MigrDatatypeTransformRuleVO migrDatatypeTransformRuleVO,
            @ModelAttribute("searchVO") MigrDatatypeTransformRuleDefaultVO searchVO, SessionStatus status)
            throws Exception {
    ...
    public String deleteMigrDatatypeTransformRule(
            MigrDatatypeTransformRuleVO migrDatatypeTransformRuleVO,
            @ModelAttribute("searchVO") MigrDatatypeTransformRuleDefaultVO searchVO, SessionStatus status)
            throws Exception {
