...
public interface ComtncntcserviceService {
	 ...
	 * @exception Exception
	 */
    List selectComtncntcserviceList(ComtncntcserviceDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtncntcserviceListTotCnt(ComtncntcserviceDefaultVO searchVO);
