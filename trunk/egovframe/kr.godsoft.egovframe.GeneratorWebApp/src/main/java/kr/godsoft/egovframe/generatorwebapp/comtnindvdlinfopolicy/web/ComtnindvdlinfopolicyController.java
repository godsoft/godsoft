...
public class ComtnindvdlinfopolicyController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnindvdlinfopolicyDefaultVO
    ...
    public String selectComtnindvdlinfopolicyList(@ModelAttribute("searchVO") ComtnindvdlinfopolicyDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnindvdlinfopolicyList = comtnindvdlinfopolicyService.selectComtnindvdlinfopolicyList(searchVO);
