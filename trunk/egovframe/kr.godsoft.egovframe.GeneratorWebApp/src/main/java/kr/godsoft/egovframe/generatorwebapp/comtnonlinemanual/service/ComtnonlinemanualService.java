...
public interface ComtnonlinemanualService {
	 ...
	 * @exception Exception
	 */
    List selectComtnonlinemanualList(ComtnonlinemanualDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtnonlinemanualListTotCnt(ComtnonlinemanualDefaultVO searchVO);
