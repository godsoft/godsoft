...
@Controller
@SessionAttributes(types=ComtnleaderschdulVO.class)
public class ComtnleaderschdulController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnleaderschdulDefaultVO
	 * @return "/comtnleaderschdul/ComtnleaderschdulList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnleaderschdul/ComtnleaderschdulList.do")
    public String selectComtnleaderschdulList(@ModelAttribute("searchVO") ComtnleaderschdulDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnleaderschdulList = comtnleaderschdulService.selectComtnleaderschdulList(searchVO);
