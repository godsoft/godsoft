...
@Controller
@SessionAttributes(types=ComtnindvdlpgeestbsVO.class)
public class ComtnindvdlpgeestbsController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnindvdlpgeestbsDefaultVO
	 * @return "/comtnindvdlpgeestbs/ComtnindvdlpgeestbsList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnindvdlpgeestbs/ComtnindvdlpgeestbsList.do")
    public String selectComtnindvdlpgeestbsList(@ModelAttribute("searchVO") ComtnindvdlpgeestbsDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnindvdlpgeestbsList = comtnindvdlpgeestbsService.selectComtnindvdlpgeestbsList(searchVO);
