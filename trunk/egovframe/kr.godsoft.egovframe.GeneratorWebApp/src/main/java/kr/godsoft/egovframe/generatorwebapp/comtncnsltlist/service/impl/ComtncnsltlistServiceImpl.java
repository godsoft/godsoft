...
import kr.godsoft.egovframe.generatorwebapp.comtncnsltlist.service.impl.ComtncnsltlistDAO;
...
public class ComtncnsltlistServiceImpl extends AbstractServiceImpl implements
    ...
    public List selectComtncnsltlistList(ComtncnsltlistDefaultVO searchVO) throws Exception {
        return comtncnsltlistDAO.selectComtncnsltlistList(searchVO);
    }
    ...
    public int selectComtncnsltlistListTotCnt(ComtncnsltlistDefaultVO searchVO) {
		return comtncnsltlistDAO.selectComtncnsltlistListTotCnt(searchVO);
	}
