...
/**
 * @Class Name : ComtnrssVO.java
 * @Description : Comtnrss VO class
...
public class ComtnrssVO extends ComtnrssDefaultVO {
    ...
    public String getHderDc() {
        return this.hderDc;
    }
    
    public void setHderDc(String hderDc) {
        this.hderDc = hderDc;
    }
    ...
    public String getBdtDc() {
        return this.bdtDc;
    }
    
    public void setBdtDc(String bdtDc) {
        this.bdtDc = bdtDc;
    }
    ...
    public String getBdtEtcTag() {
        return this.bdtEtcTag;
    }
    
    public void setBdtEtcTag(String bdtEtcTag) {
