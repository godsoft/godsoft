...
public class ComtnwikmnthngreprtController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnwikmnthngreprtVO
	 * @return "/comtnwikmnthngreprt/ComtnwikmnthngreprtList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnwikmnthngreprt/ComtnwikmnthngreprtList.do")
    public String selectComtnwikmnthngreprtList(@ModelAttribute("searchVO") ComtnwikmnthngreprtVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List<EgovMap> comtnwikmnthngreprtList = comtnwikmnthngreprtService.selectComtnwikmnthngreprtList(searchVO);
