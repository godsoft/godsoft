...
public class ComtnqustnrtmplatController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnqustnrtmplatDefaultVO
	 * @return "/comtnqustnrtmplat/ComtnqustnrtmplatList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnqustnrtmplat/ComtnqustnrtmplatList.do")
    public String selectComtnqustnrtmplatList(@ModelAttribute("searchVO") ComtnqustnrtmplatDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnqustnrtmplatList = comtnqustnrtmplatService.selectComtnqustnrtmplatList(searchVO);
