...
/**
 * @Class Name : ComtcadministcoderecptnlogVO.java
 * @Description : Comtcadministcoderecptnlog VO class
...
public class ComtcadministcoderecptnlogVO extends ComtcadministcoderecptnlogDefaultVO {
    ...
    public String getLowestAdministZoneNm() {
        return this.lowestAdministZoneNm;
    }
