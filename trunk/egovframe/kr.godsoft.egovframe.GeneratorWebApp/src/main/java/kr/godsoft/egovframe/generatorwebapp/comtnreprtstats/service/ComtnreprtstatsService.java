...
public interface ComtnreprtstatsService {
	 ...
	 * @exception Exception
	 */
    List selectComtnreprtstatsList(ComtnreprtstatsDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtnreprtstatsListTotCnt(ComtnreprtstatsDefaultVO searchVO);
