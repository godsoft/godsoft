...
/**
 * @Class Name : ComtnentrprsmberVO.java
 * @Description : Comtnentrprsmber VO class
...
public class ComtnentrprsmberVO extends ComtnentrprsmberDefaultVO {
    ...
    public String getEntrprsMiddleTelno() {
        return this.entrprsMiddleTelno;
    }
    ...
    public String getEntrprsMberPassword() {
        return this.entrprsMberPassword;
    }
    ...
    public String getEntrprsMberPasswordHint() {
        return this.entrprsMberPasswordHint;
    }
    ...
    public String getEntrprsMberPasswordCnsr() {
        return this.entrprsMberPasswordCnsr;
    }
