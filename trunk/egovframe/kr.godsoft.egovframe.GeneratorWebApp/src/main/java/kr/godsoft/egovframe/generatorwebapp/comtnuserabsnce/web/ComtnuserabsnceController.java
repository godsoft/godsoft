...
public class ComtnuserabsnceController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnuserabsnceVO
	 * @return "/comtnuserabsnce/ComtnuserabsnceList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnuserabsnce/ComtnuserabsnceList.do")
    public String selectComtnuserabsnceList(@ModelAttribute("searchVO") ComtnuserabsnceVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List<EgovMap> comtnuserabsnceList = comtnuserabsnceService.selectComtnuserabsnceList(searchVO);
