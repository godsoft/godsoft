...
public class ComtnbatchresultController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnbatchresultVO
	 * @return "/comtnbatchresult/ComtnbatchresultList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnbatchresult/ComtnbatchresultList.do")
    public String selectComtnbatchresultList(@ModelAttribute("searchVO") ComtnbatchresultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List<EgovMap> comtnbatchresultList = comtnbatchresultService.selectComtnbatchresultList(searchVO);
