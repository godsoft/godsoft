...
public interface ComtnfilesysmntrngloginfoService {
	 ...
	 * @exception Exception
	 */
    List selectComtnfilesysmntrngloginfoList(ComtnfilesysmntrngloginfoDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtnfilesysmntrngloginfoListTotCnt(ComtnfilesysmntrngloginfoDefaultVO searchVO);
