...
/**
 * @Class Name : ComtntroblinfoVO.java
 * @Description : Comtntroblinfo VO class
...
public class ComtntroblinfoVO extends ComtntroblinfoDefaultVO {
    ...
    public String getTroblProcessResult() {
        return this.troblProcessResult;
    }
