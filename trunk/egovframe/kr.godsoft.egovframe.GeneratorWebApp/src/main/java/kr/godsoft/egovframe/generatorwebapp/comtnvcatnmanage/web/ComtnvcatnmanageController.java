...
public class ComtnvcatnmanageController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnvcatnmanageVO
	 * @return "/comtnvcatnmanage/ComtnvcatnmanageList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnvcatnmanage/ComtnvcatnmanageList.do")
    public String selectComtnvcatnmanageList(@ModelAttribute("searchVO") ComtnvcatnmanageVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List<EgovMap> comtnvcatnmanageList = comtnvcatnmanageService.selectComtnvcatnmanageList(searchVO);
