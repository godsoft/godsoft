...
@Controller
@SessionAttributes(types=ComtndamproVO.class)
public class ComtndamproController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtndamproDefaultVO
	 * @return "/comtndampro/ComtndamproList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtndampro/ComtndamproList.do")
    public String selectComtndamproList(@ModelAttribute("searchVO") ComtndamproDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtndamproList = comtndamproService.selectComtndamproList(searchVO);
    ...
    public String addComtndamproView(
            @ModelAttribute("searchVO") ComtndamproDefaultVO searchVO, Model model)
            throws Exception {
    ...
    public String addComtndampro(
            ComtndamproVO comtndamproVO,
            @ModelAttribute("searchVO") ComtndamproDefaultVO searchVO, SessionStatus status)
            throws Exception {
...
;        
    ...
    public String deleteComtndampro(
            ComtndamproVO comtndamproVO,
            @ModelAttribute("searchVO") ComtndamproDefaultVO searchVO, SessionStatus status)
            throws Exception {
