...
/**
 * @Class Name : ComtnbackupopertVO.java
 * @Description : Comtnbackupopert VO class
...
public class ComtnbackupopertVO extends ComtnbackupopertDefaultVO {
    ...
    public String getBackupOrginlDrctry() {
        return this.backupOrginlDrctry;
    }
