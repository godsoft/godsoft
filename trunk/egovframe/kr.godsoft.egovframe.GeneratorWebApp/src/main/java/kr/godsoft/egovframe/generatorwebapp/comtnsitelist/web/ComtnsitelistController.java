...
public class ComtnsitelistController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnsitelistDefaultVO
	 * @return "/comtnsitelist/ComtnsitelistList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnsitelist/ComtnsitelistList.do")
    public String selectComtnsitelistList(@ModelAttribute("searchVO") ComtnsitelistDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnsitelistList = comtnsitelistService.selectComtnsitelistList(searchVO);
