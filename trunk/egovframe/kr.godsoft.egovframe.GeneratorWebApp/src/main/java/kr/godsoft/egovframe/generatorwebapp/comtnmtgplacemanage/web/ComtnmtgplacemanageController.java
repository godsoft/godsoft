...
public class ComtnmtgplacemanageController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnmtgplacemanageVO
	 * @return "/comtnmtgplacemanage/ComtnmtgplacemanageList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnmtgplacemanage/ComtnmtgplacemanageList.do")
    public String selectComtnmtgplacemanageList(@ModelAttribute("searchVO") ComtnmtgplacemanageVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List<EgovMap> comtnmtgplacemanageList = comtnmtgplacemanageService.selectComtnmtgplacemanageList(searchVO);
