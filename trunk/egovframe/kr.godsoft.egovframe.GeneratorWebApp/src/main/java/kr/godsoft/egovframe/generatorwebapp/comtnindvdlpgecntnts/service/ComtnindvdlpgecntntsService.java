...
public interface ComtnindvdlpgecntntsService {
	 ...
	 * @exception Exception
	 */
    List selectComtnindvdlpgecntntsList(ComtnindvdlpgecntntsDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtnindvdlpgecntntsListTotCnt(ComtnindvdlpgecntntsDefaultVO searchVO);
