...
@Controller
@SessionAttributes(types=ComtncntcserviceVO.class)
public class ComtncntcserviceController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtncntcserviceDefaultVO
	 * @return "/comtncntcservice/ComtncntcserviceList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtncntcservice/ComtncntcserviceList.do")
    public String selectComtncntcserviceList(@ModelAttribute("searchVO") ComtncntcserviceDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtncntcserviceList = comtncntcserviceService.selectComtncntcserviceList(searchVO);
