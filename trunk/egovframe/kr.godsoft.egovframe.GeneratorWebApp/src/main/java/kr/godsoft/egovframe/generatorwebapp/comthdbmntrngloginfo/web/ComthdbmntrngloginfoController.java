...
@Controller
@SessionAttributes(types=ComthdbmntrngloginfoVO.class)
public class ComthdbmntrngloginfoController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComthdbmntrngloginfoDefaultVO
    ...
    public String selectComthdbmntrngloginfoList(@ModelAttribute("searchVO") ComthdbmntrngloginfoDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comthdbmntrngloginfoList = comthdbmntrngloginfoService.selectComthdbmntrngloginfoList(searchVO);
