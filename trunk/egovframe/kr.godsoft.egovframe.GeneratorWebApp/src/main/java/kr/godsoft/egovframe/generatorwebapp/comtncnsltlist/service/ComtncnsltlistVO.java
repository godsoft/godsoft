...
/**
 * @Class Name : ComtncnsltlistVO.java
 * @Description : Comtncnsltlist VO class
...
public class ComtncnsltlistVO extends ComtncnsltlistDefaultVO {
    ...
    public String getFrstMbtlnum() {
        return this.frstMbtlnum;
    }
    
    public void setFrstMbtlnum(String frstMbtlnum) {
        this.frstMbtlnum = frstMbtlnum;
    }
    
    public String getMiddleMbtlnum() {
        return this.middleMbtlnum;
    }
