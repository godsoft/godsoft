...
@Controller
@SessionAttributes(types=ComtntrsmrcvlogVO.class)
public class ComtntrsmrcvlogController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtntrsmrcvlogDefaultVO
	 * @return "/comtntrsmrcvlog/ComtntrsmrcvlogList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtntrsmrcvlog/ComtntrsmrcvlogList.do")
    public String selectComtntrsmrcvlogList(@ModelAttribute("searchVO") ComtntrsmrcvlogDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtntrsmrcvlogList = comtntrsmrcvlogService.selectComtntrsmrcvlogList(searchVO);
