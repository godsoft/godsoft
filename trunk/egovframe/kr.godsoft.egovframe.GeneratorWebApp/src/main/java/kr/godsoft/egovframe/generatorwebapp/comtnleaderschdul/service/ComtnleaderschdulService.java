...
public interface ComtnleaderschdulService {
	 ...
	 * @exception Exception
	 */
    List selectComtnleaderschdulList(ComtnleaderschdulDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtnleaderschdulListTotCnt(ComtnleaderschdulDefaultVO searchVO);
