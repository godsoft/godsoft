...
/**
 * @Class Name : ComtneventmanageVO.java
 * @Description : Comtneventmanage VO class
...
public class ComtneventmanageVO extends ComtneventmanageDefaultVO {
    ...
    public String getEventBgnde() {
        return this.eventBgnde;
    }
    
    public void setEventBgnde(String eventBgnde) {
        this.eventBgnde = eventBgnde;
    }
    
    public String getEventEndde() {
        return this.eventEndde;
    }
    ...
    public String getRceptBgnde() {
        return this.rceptBgnde;
    }
    
    public void setRceptBgnde(String rceptBgnde) {
        this.rceptBgnde = rceptBgnde;
    }
    
    public String getRceptEndde() {
        return this.rceptEndde;
    }
