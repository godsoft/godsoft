...
public interface ComtnbatchopertService {
	 ...
	 * @exception Exception
	 */
    List selectComtnbatchopertList(ComtnbatchopertDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtnbatchopertListTotCnt(ComtnbatchopertDefaultVO searchVO);
