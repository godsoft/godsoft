...
public class ComtncnsltlistController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtncnsltlistDefaultVO
	 * @return "/comtncnsltlist/ComtncnsltlistList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtncnsltlist/ComtncnsltlistList.do")
    public String selectComtncnsltlistList(@ModelAttribute("searchVO") ComtncnsltlistDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtncnsltlistList = comtncnsltlistService.selectComtncnsltlistList(searchVO);
