...
public class MgvAllCapturedSqlServiceImpl extends AbstractServiceImpl implements
        MgvAllCapturedSqlService {

    @Resource(name="mgvAllCapturedSqlDAO")
    private MgvAllCapturedSqlDAO mgvAllCapturedSqlDAO;
    
    /** ID Generation */
    //@Resource(name="{egovMgvAllCapturedSqlIdGnrService}")    
