...
public class ComtnbkmkmenumanageresultController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnbkmkmenumanageresultDefaultVO
    ...
    public String selectComtnbkmkmenumanageresultList(@ModelAttribute("searchVO") ComtnbkmkmenumanageresultDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnbkmkmenumanageresultList = comtnbkmkmenumanageresultService.selectComtnbkmkmenumanageresultList(searchVO);
