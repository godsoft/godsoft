...
public class ComtnadministrationwordController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnadministrationwordVO
    ...
    public String selectComtnadministrationwordList(@ModelAttribute("searchVO") ComtnadministrationwordVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List<EgovMap> comtnadministrationwordList = comtnadministrationwordService.selectComtnadministrationwordList(searchVO);
