...
public interface ComtnsynchrnserverinfoService {
	 ...
	 * @exception Exception
	 */
    List selectComtnsynchrnserverinfoList(ComtnsynchrnserverinfoDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtnsynchrnserverinfoListTotCnt(ComtnsynchrnserverinfoDefaultVO searchVO);
