...
/**
 * @Class Name : ComtndamcalresVO.java
 * @Description : Comtndamcalres VO class
...
public class ComtndamcalresVO extends ComtndamcalresDefaultVO {
    ...
    public String getParntsKnwldgId() {
        return this.parntsKnwldgId;
    }
    
    public void setParntsKnwldgId(String parntsKnwldgId) {
