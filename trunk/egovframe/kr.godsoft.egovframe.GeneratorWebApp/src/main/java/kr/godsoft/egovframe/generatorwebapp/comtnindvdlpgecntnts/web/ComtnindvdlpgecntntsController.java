...
@Controller
@SessionAttributes(types=ComtnindvdlpgecntntsVO.class)
public class ComtnindvdlpgecntntsController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnindvdlpgecntntsDefaultVO
    ...
    public String selectComtnindvdlpgecntntsList(@ModelAttribute("searchVO") ComtnindvdlpgecntntsDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnindvdlpgecntntsList = comtnindvdlpgecntntsService.selectComtnindvdlpgecntntsList(searchVO);
