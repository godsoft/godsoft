...
@Controller
@SessionAttributes(types=ComtnproxyinfoVO.class)
public class ComtnproxyinfoController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnproxyinfoDefaultVO
	 * @return "/comtnproxyinfo/ComtnproxyinfoList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnproxyinfo/ComtnproxyinfoList.do")
    public String selectComtnproxyinfoList(@ModelAttribute("searchVO") ComtnproxyinfoDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnproxyinfoList = comtnproxyinfoService.selectComtnproxyinfoList(searchVO);
