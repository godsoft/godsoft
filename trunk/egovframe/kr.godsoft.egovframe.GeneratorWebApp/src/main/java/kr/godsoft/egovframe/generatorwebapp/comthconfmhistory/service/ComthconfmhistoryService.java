...
public interface ComthconfmhistoryService {
	 ...
	 * @exception Exception
	 */
    List selectComthconfmhistoryList(ComthconfmhistoryDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComthconfmhistoryListTotCnt(ComthconfmhistoryDefaultVO searchVO);
