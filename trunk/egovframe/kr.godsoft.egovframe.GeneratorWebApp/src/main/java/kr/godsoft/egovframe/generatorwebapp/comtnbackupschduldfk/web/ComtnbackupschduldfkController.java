...
@Controller
@SessionAttributes(types=ComtnbackupschduldfkVO.class)
public class ComtnbackupschduldfkController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnbackupschduldfkDefaultVO
    ...
    public String selectComtnbackupschduldfkList(@ModelAttribute("searchVO") ComtnbackupschduldfkDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnbackupschduldfkList = comtnbackupschduldfkService.selectComtnbackupschduldfkList(searchVO);
