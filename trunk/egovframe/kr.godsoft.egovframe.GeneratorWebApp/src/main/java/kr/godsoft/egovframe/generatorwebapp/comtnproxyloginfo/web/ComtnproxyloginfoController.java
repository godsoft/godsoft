...
public class ComtnproxyloginfoController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnproxyloginfoVO
	 * @return "/comtnproxyloginfo/ComtnproxyloginfoList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnproxyloginfo/ComtnproxyloginfoList.do")
    public String selectComtnproxyloginfoList(@ModelAttribute("searchVO") ComtnproxyloginfoVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List<EgovMap> comtnproxyloginfoList = comtnproxyloginfoService.selectComtnproxyloginfoList(searchVO);
