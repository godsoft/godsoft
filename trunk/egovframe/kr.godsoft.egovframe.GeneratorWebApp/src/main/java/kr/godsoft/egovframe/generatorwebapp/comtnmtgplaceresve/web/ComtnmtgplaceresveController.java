...
public class ComtnmtgplaceresveController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnmtgplaceresveDefaultVO
	 * @return "/comtnmtgplaceresve/ComtnmtgplaceresveList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnmtgplaceresve/ComtnmtgplaceresveList.do")
    public String selectComtnmtgplaceresveList(@ModelAttribute("searchVO") ComtnmtgplaceresveDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnmtgplaceresveList = comtnmtgplaceresveService.selectComtnmtgplaceresveList(searchVO);
