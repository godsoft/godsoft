...
public interface ComtnadbkmanageService {
	 ...
	 * @exception Exception
	 */
    List selectComtnadbkmanageList(ComtnadbkmanageDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtnadbkmanageListTotCnt(ComtnadbkmanageDefaultVO searchVO);
