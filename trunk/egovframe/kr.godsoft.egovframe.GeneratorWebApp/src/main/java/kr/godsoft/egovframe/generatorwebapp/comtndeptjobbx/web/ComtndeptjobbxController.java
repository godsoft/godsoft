...
@Controller
@SessionAttributes(types=ComtndeptjobbxVO.class)
public class ComtndeptjobbxController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtndeptjobbxDefaultVO
	 * @return "/comtndeptjobbx/ComtndeptjobbxList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtndeptjobbx/ComtndeptjobbxList.do")
    public String selectComtndeptjobbxList(@ModelAttribute("searchVO") ComtndeptjobbxDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtndeptjobbxList = comtndeptjobbxService.selectComtndeptjobbxList(searchVO);
