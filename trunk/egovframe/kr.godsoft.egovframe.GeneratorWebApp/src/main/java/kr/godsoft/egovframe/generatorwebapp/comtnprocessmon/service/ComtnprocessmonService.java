...
public interface ComtnprocessmonService {
	 ...
	 * @exception Exception
	 */
    List selectComtnprocessmonList(ComtnprocessmonDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtnprocessmonListTotCnt(ComtnprocessmonDefaultVO searchVO);
