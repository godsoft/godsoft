...
/**
 * @Class Name : ComtnpopupmanageVO.java
 * @Description : Comtnpopupmanage VO class
...
public class ComtnpopupmanageVO extends ComtnpopupmanageDefaultVO {
    ...
    public String getPopupSjNm() {
        return this.popupSjNm;
    }
    
    public void setPopupSjNm(String popupSjNm) {
