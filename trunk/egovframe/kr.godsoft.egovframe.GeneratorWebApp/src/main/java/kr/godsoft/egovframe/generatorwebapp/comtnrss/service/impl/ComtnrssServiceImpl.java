...
import kr.godsoft.egovframe.generatorwebapp.comtnrss.service.impl.ComtnrssDAO;
...
public class ComtnrssServiceImpl extends AbstractServiceImpl implements
	 ...
	 * @exception Exception
	 */
    public List selectComtnrssList(ComtnrssDefaultVO searchVO) throws Exception {
        return comtnrssDAO.selectComtnrssList(searchVO);
    }
	 ...
	 * @exception
	 */
    public int selectComtnrssListTotCnt(ComtnrssDefaultVO searchVO) {
		return comtnrssDAO.selectComtnrssListTotCnt(searchVO);
	}
