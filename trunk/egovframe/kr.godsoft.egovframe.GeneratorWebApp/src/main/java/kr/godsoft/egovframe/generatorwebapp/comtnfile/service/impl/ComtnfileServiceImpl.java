...
import kr.godsoft.egovframe.generatorwebapp.comtnfile.service.impl.ComtnfileDAO;
...
public class ComtnfileServiceImpl extends AbstractServiceImpl implements
	 ...
	 * @exception Exception
	 */
    public List selectComtnfileList(ComtnfileDefaultVO searchVO) throws Exception {
        return comtnfileDAO.selectComtnfileList(searchVO);
    }
	 ...
	 * @exception
	 */
    public int selectComtnfileListTotCnt(ComtnfileDefaultVO searchVO) {
		return comtnfileDAO.selectComtnfileListTotCnt(searchVO);
	}
