...
public interface ComtnbbsmasteroptnService {
	 ...
	 * @exception Exception
	 */
    List selectComtnbbsmasteroptnList(ComtnbbsmasteroptnDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtnbbsmasteroptnListTotCnt(ComtnbbsmasteroptnDefaultVO searchVO);
