...
@Controller
@SessionAttributes(types=ComtnannvrsrymanageVO.class)
public class ComtnannvrsrymanageController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnannvrsrymanageDefaultVO
	 * @return "/comtnannvrsrymanage/ComtnannvrsrymanageList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnannvrsrymanage/ComtnannvrsrymanageList.do")
    public String selectComtnannvrsrymanageList(@ModelAttribute("searchVO") ComtnannvrsrymanageDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnannvrsrymanageList = comtnannvrsrymanageService.selectComtnannvrsrymanageList(searchVO);
    ...
    public String addComtnannvrsrymanageView(
            @ModelAttribute("searchVO") ComtnannvrsrymanageDefaultVO searchVO, Model model)
            throws Exception {
    ...
    public String addComtnannvrsrymanage(
            ComtnannvrsrymanageVO comtnannvrsrymanageVO,
            @ModelAttribute("searchVO") ComtnannvrsrymanageDefaultVO searchVO, SessionStatus status)
            throws Exception {
    ...
    public String updateComtnannvrsrymanageView(
            @RequestParam("annvrsryId") String annvrsryId ,
            @ModelAttribute("searchVO") ComtnannvrsrymanageDefaultVO searchVO, Model model)
            throws Exception {
        ComtnannvrsrymanageVO comtnannvrsrymanageVO = new ComtnannvrsrymanageVO();
        comtnannvrsrymanageVO.setAnnvrsryId(annvrsryId);
;        
        // 변수명은 CoC 에 따라 comtnannvrsrymanageVO
    ...
    public @ModelAttribute("comtnannvrsrymanageVO")
    ComtnannvrsrymanageVO selectComtnannvrsrymanage(
            ComtnannvrsrymanageVO comtnannvrsrymanageVO,
            @ModelAttribute("searchVO") ComtnannvrsrymanageDefaultVO searchVO) throws Exception {
    ...
    public String updateComtnannvrsrymanage(
            ComtnannvrsrymanageVO comtnannvrsrymanageVO,
            @ModelAttribute("searchVO") ComtnannvrsrymanageDefaultVO searchVO, SessionStatus status)
            throws Exception {
    ...
    public String deleteComtnannvrsrymanage(
            ComtnannvrsrymanageVO comtnannvrsrymanageVO,
            @ModelAttribute("searchVO") ComtnannvrsrymanageDefaultVO searchVO, SessionStatus status)
            throws Exception {
