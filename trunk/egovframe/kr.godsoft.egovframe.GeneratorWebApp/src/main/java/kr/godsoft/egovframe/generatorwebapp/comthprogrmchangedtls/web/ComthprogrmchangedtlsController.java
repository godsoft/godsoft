...
public class ComthprogrmchangedtlsController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComthprogrmchangedtlsVO
    ...
    public String selectComthprogrmchangedtlsList(@ModelAttribute("searchVO") ComthprogrmchangedtlsVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List<EgovMap> comthprogrmchangedtlsList = comthprogrmchangedtlsService.selectComthprogrmchangedtlsList(searchVO);
    ...
    public String updateComthprogrmchangedtlsView(
            ...
            @RequestParam("requstNo") String requstNo ,
            @ModelAttribute("searchVO") ComthprogrmchangedtlsDefaultVO searchVO, Model model)
            throws Exception {
