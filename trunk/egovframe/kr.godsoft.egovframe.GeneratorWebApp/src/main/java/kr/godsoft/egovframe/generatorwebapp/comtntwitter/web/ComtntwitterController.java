...
public class ComtntwitterController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtntwitterDefaultVO
	 * @return "/comtntwitter/ComtntwitterList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtntwitter/ComtntwitterList.do")
    public String selectComtntwitterList(@ModelAttribute("searchVO") ComtntwitterDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtntwitterList = comtntwitterService.selectComtntwitterList(searchVO);
