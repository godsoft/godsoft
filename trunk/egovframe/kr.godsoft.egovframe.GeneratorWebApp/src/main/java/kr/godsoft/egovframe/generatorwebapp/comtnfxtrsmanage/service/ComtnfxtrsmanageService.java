...
public interface ComtnfxtrsmanageService {
	 ...
	 * @exception Exception
	 */
    List selectComtnfxtrsmanageList(ComtnfxtrsmanageDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtnfxtrsmanageListTotCnt(ComtnfxtrsmanageDefaultVO searchVO);
