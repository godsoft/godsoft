...
@Controller
@SessionAttributes(types=ComtnwikibkmkVO.class)
public class ComtnwikibkmkController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnwikibkmkDefaultVO
	 * @return "/comtnwikibkmk/ComtnwikibkmkList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnwikibkmk/ComtnwikibkmkList.do")
    public String selectComtnwikibkmkList(@ModelAttribute("searchVO") ComtnwikibkmkDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnwikibkmkList = comtnwikibkmkService.selectComtnwikibkmkList(searchVO);
    ...
    public String addComtnwikibkmkView(
            @ModelAttribute("searchVO") ComtnwikibkmkDefaultVO searchVO, Model model)
            throws Exception {
    ...
    public String addComtnwikibkmk(
            ComtnwikibkmkVO comtnwikibkmkVO,
            @ModelAttribute("searchVO") ComtnwikibkmkDefaultVO searchVO, SessionStatus status)
            throws Exception {
    ...
    public String updateComtnwikibkmkView(
            @RequestParam("wikiBkmkId") String wikiBkmkId ,
...
;        
    ...
    public String deleteComtnwikibkmk(
            ComtnwikibkmkVO comtnwikibkmkVO,
            @ModelAttribute("searchVO") ComtnwikibkmkDefaultVO searchVO, SessionStatus status)
            throws Exception {
