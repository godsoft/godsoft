...
public class ComtndtausestatsController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtndtausestatsDefaultVO
	 * @return "/comtndtausestats/ComtndtausestatsList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtndtausestats/ComtndtausestatsList.do")
    public String selectComtndtausestatsList(@ModelAttribute("searchVO") ComtndtausestatsDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtndtausestatsList = comtndtausestatsService.selectComtndtausestatsList(searchVO);
