...
public class ComtnclubController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnclubDefaultVO
	 * @return "/comtnclub/ComtnclubList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnclub/ComtnclubList.do")
    public String selectComtnclubList(@ModelAttribute("searchVO") ComtnclubDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnclubList = comtnclubService.selectComtnclubList(searchVO);
