...
public interface ComtnstplatinfoService {
	 ...
	 * @exception Exception
	 */
    List selectComtnstplatinfoList(ComtnstplatinfoDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtnstplatinfoListTotCnt(ComtnstplatinfoDefaultVO searchVO);
