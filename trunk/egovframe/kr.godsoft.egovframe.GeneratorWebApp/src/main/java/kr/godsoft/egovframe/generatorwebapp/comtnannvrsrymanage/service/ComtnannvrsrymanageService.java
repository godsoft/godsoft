...
public interface ComtnannvrsrymanageService {
	 ...
	 * @exception Exception
	 */
    List selectComtnannvrsrymanageList(ComtnannvrsrymanageDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtnannvrsrymanageListTotCnt(ComtnannvrsrymanageDefaultVO searchVO);
