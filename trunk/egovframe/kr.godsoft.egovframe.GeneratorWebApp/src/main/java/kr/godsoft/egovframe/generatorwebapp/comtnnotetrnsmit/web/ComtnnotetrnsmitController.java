...
@Controller
@SessionAttributes(types=ComtnnotetrnsmitVO.class)
public class ComtnnotetrnsmitController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnnotetrnsmitDefaultVO
	 * @return "/comtnnotetrnsmit/ComtnnotetrnsmitList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnnotetrnsmit/ComtnnotetrnsmitList.do")
    public String selectComtnnotetrnsmitList(@ModelAttribute("searchVO") ComtnnotetrnsmitDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnnotetrnsmitList = comtnnotetrnsmitService.selectComtnnotetrnsmitList(searchVO);
