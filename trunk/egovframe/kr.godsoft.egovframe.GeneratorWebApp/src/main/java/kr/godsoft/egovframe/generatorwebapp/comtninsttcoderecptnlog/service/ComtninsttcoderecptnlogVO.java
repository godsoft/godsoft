...
/**
 * @Class Name : ComtninsttcoderecptnlogVO.java
 * @Description : Comtninsttcoderecptnlog VO class
 ...
 */
public class ComtninsttcoderecptnlogVO extends ComtninsttcoderecptnlogDefaultVO {
    ...
    public String getInsttTyMlsfc() {
        return this.insttTyMlsfc;
    }
    
    public void setInsttTyMlsfc(String insttTyMlsfc) {
        this.insttTyMlsfc = insttTyMlsfc;
    }
    
    public String getInsttTySclas() {
        return this.insttTySclas;
    }
