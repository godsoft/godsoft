...
/**
 * @Class Name : ComtnctsnnmanageVO.java
 * @Description : Comtnctsnnmanage VO class
...
public class ComtnctsnnmanageVO extends ComtnctsnnmanageDefaultVO {
    ...
    public String getCtsnnCode() {
        return this.ctsnnCode;
    }
    
    public void setCtsnnCode(String ctsnnCode) {
        this.ctsnnCode = ctsnnCode;
    }
