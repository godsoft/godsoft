...
public class ComtnsmsController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnsmsVO
	 * @return "/comtnsms/ComtnsmsList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnsms/ComtnsmsList.do")
    public String selectComtnsmsList(@ModelAttribute("searchVO") ComtnsmsVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List<EgovMap> comtnsmsList = comtnsmsService.selectComtnsmsList(searchVO);
