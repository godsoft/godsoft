...
@Controller
@SessionAttributes(types=ComtneventinfoVO.class)
public class ComtneventinfoController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtneventinfoDefaultVO
	 * @return "/comtneventinfo/ComtneventinfoList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtneventinfo/ComtneventinfoList.do")
    public String selectComtneventinfoList(@ModelAttribute("searchVO") ComtneventinfoDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtneventinfoList = comtneventinfoService.selectComtneventinfoList(searchVO);
