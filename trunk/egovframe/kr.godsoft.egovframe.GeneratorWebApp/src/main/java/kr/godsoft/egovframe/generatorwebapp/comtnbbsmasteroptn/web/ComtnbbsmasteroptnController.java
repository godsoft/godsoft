...
public class ComtnbbsmasteroptnController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnbbsmasteroptnDefaultVO
	 * @return "/comtnbbsmasteroptn/ComtnbbsmasteroptnList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnbbsmasteroptn/ComtnbbsmasteroptnList.do")
    public String selectComtnbbsmasteroptnList(@ModelAttribute("searchVO") ComtnbbsmasteroptnDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnbbsmasteroptnList = comtnbbsmasteroptnService.selectComtnbbsmasteroptnList(searchVO);
