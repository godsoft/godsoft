...
@Controller
@SessionAttributes(types=ComtninsttcoderecptnlogVO.class)
public class ComtninsttcoderecptnlogController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtninsttcoderecptnlogDefaultVO
    ...
    public String selectComtninsttcoderecptnlogList(@ModelAttribute("searchVO") ComtninsttcoderecptnlogDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtninsttcoderecptnlogList = comtninsttcoderecptnlogService.selectComtninsttcoderecptnlogList(searchVO);
