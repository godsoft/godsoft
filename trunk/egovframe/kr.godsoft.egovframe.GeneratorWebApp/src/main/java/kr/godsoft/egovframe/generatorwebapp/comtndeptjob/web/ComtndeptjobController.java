...
@Controller
@SessionAttributes(types=ComtndeptjobVO.class)
public class ComtndeptjobController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtndeptjobDefaultVO
	 * @return "/comtndeptjob/ComtndeptjobList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtndeptjob/ComtndeptjobList.do")
    public String selectComtndeptjobList(@ModelAttribute("searchVO") ComtndeptjobDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtndeptjobList = comtndeptjobService.selectComtndeptjobList(searchVO);
