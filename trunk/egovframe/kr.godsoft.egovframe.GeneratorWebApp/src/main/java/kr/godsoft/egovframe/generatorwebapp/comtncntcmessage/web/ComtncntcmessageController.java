...
public class ComtncntcmessageController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtncntcmessageDefaultVO
	 * @return "/comtncntcmessage/ComtncntcmessageList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtncntcmessage/ComtncntcmessageList.do")
    public String selectComtncntcmessageList(@ModelAttribute("searchVO") ComtncntcmessageDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtncntcmessageList = comtncntcmessageService.selectComtncntcmessageList(searchVO);
