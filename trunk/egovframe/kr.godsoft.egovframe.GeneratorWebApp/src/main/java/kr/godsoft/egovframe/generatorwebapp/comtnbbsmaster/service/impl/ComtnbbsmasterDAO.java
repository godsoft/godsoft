...
public class ComtnbbsmasterDAO extends EgovAbstractDAO {
    ...
    public List selectComtnbbsmasterList(ComtnbbsmasterDefaultVO searchVO) throws Exception {
        return list("comtnbbsmasterDAO.selectComtnbbsmasterList_D", searchVO);
    }
    ...
    public int selectComtnbbsmasterListTotCnt(ComtnbbsmasterDefaultVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("comtnbbsmasterDAO.selectComtnbbsmasterListTotCnt_S", searchVO);
    }
