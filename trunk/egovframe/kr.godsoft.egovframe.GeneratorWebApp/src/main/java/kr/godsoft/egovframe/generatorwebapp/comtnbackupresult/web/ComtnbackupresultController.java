...
public class ComtnbackupresultController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnbackupresultVO
	 * @return "/comtnbackupresult/ComtnbackupresultList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnbackupresult/ComtnbackupresultList.do")
    public String selectComtnbackupresultList(@ModelAttribute("searchVO") ComtnbackupresultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List<EgovMap> comtnbackupresultList = comtnbackupresultService.selectComtnbackupresultList(searchVO);
