...
@Controller
@SessionAttributes(types=ComtrdnmadrzipVO.class)
public class ComtrdnmadrzipController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtrdnmadrzipDefaultVO
	 * @return "/comtrdnmadrzip/ComtrdnmadrzipList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtrdnmadrzip/ComtrdnmadrzipList.do")
    public String selectComtrdnmadrzipList(@ModelAttribute("searchVO") ComtrdnmadrzipDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtrdnmadrzipList = comtrdnmadrzipService.selectComtrdnmadrzipList(searchVO);
