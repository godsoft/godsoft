...
public class ComtnntwrksvcmntrngDAO extends EgovAbstractDAO {
    ...
    public List selectComtnntwrksvcmntrngList(ComtnntwrksvcmntrngDefaultVO searchVO) throws Exception {
        return list("comtnntwrksvcmntrngDAO.selectComtnntwrksvcmntrngList_D", searchVO);
    }
    ...
    public int selectComtnntwrksvcmntrngListTotCnt(ComtnntwrksvcmntrngDefaultVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("comtnntwrksvcmntrngDAO.selectComtnntwrksvcmntrngListTotCnt_S", searchVO);
    }
