...
public class ComtnfileDAO extends EgovAbstractDAO {
    ...
    public List selectComtnfileList(ComtnfileDefaultVO searchVO) throws Exception {
        return list("comtnfileDAO.selectComtnfileList_D", searchVO);
    }
    ...
    public int selectComtnfileListTotCnt(ComtnfileDefaultVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("comtnfileDAO.selectComtnfileListTotCnt_S", searchVO);
    }
