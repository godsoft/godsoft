...
public interface ComtninsttcoderecptnlogService {
	 ...
	 * @exception Exception
	 */
    List selectComtninsttcoderecptnlogList(ComtninsttcoderecptnlogDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtninsttcoderecptnlogListTotCnt(ComtninsttcoderecptnlogDefaultVO searchVO);
