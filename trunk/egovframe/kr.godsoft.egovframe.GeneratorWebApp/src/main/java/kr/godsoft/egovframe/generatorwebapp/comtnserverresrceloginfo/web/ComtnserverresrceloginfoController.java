...
@Controller
@SessionAttributes(types=ComtnserverresrceloginfoVO.class)
public class ComtnserverresrceloginfoController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnserverresrceloginfoDefaultVO
    ...
    public String selectComtnserverresrceloginfoList(@ModelAttribute("searchVO") ComtnserverresrceloginfoDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comtnserverresrceloginfoList = comtnserverresrceloginfoService.selectComtnserverresrceloginfoList(searchVO);
