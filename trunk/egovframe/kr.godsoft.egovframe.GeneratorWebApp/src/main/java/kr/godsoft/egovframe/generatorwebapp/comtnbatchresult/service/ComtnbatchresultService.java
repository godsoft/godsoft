...
public interface ComtnbatchresultService {
	 ...
	 * @exception Exception
	 */
    List selectComtnbatchresultList(ComtnbatchresultDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtnbatchresultListTotCnt(ComtnbatchresultDefaultVO searchVO);
