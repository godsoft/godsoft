...
@Controller
@SessionAttributes(types=ComthhttpmonloginfoVO.class)
public class ComthhttpmonloginfoController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComthhttpmonloginfoDefaultVO
	 * @return "/comthhttpmonloginfo/ComthhttpmonloginfoList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comthhttpmonloginfo/ComthhttpmonloginfoList.do")
    public String selectComthhttpmonloginfoList(@ModelAttribute("searchVO") ComthhttpmonloginfoDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List comthhttpmonloginfoList = comthhttpmonloginfoService.selectComthhttpmonloginfoList(searchVO);
    ...
    public String addComthhttpmonloginfoView(
            @ModelAttribute("searchVO") ComthhttpmonloginfoDefaultVO searchVO, Model model)
            throws Exception {
    ...
    public String addComthhttpmonloginfo(
            ComthhttpmonloginfoVO comthhttpmonloginfoVO,
            @ModelAttribute("searchVO") ComthhttpmonloginfoDefaultVO searchVO, SessionStatus status)
            throws Exception {
    ...
    public String updateComthhttpmonloginfoView(
...
;        
        // 변수명은 CoC 에 따라 comthhttpmonloginfoVO
    ...
    public @ModelAttribute("comthhttpmonloginfoVO")
    ComthhttpmonloginfoVO selectComthhttpmonloginfo(
            ComthhttpmonloginfoVO comthhttpmonloginfoVO,
            @ModelAttribute("searchVO") ComthhttpmonloginfoDefaultVO searchVO) throws Exception {
    ...
    public String updateComthhttpmonloginfo(
            ComthhttpmonloginfoVO comthhttpmonloginfoVO,
            @ModelAttribute("searchVO") ComthhttpmonloginfoDefaultVO searchVO, SessionStatus status)
            throws Exception {
    ...
    public String deleteComthhttpmonloginfo(
            ComthhttpmonloginfoVO comthhttpmonloginfoVO,
            @ModelAttribute("searchVO") ComthhttpmonloginfoDefaultVO searchVO, SessionStatus status)
            throws Exception {
