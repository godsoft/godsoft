...
public class ComtnservereqpmninfoDAO extends EgovAbstractDAO {
    ...
    public List selectComtnservereqpmninfoList(ComtnservereqpmninfoDefaultVO searchVO) throws Exception {
        return list("comtnservereqpmninfoDAO.selectComtnservereqpmninfoList_D", searchVO);
    }
    ...
    public int selectComtnservereqpmninfoListTotCnt(ComtnservereqpmninfoDefaultVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("comtnservereqpmninfoDAO.selectComtnservereqpmninfoListTotCnt_S", searchVO);
    }
