...
public interface ComtnrwardmanageService {
	 ...
	 * @exception Exception
	 */
    List selectComtnrwardmanageList(ComtnrwardmanageDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtnrwardmanageListTotCnt(ComtnrwardmanageDefaultVO searchVO);
