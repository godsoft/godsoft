...
public interface ComtnntwrksvcmntrngloginfoService {
	 ...
	 * @exception Exception
	 */
    List selectComtnntwrksvcmntrngloginfoList(ComtnntwrksvcmntrngloginfoDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtnntwrksvcmntrngloginfoListTotCnt(ComtnntwrksvcmntrngloginfoDefaultVO searchVO);
