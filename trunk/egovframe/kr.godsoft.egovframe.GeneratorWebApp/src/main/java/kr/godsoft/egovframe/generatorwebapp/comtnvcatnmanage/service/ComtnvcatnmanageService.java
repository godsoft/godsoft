...
public interface ComtnvcatnmanageService {
	 ...
	 * @exception Exception
	 */
    List selectComtnvcatnmanageList(ComtnvcatnmanageDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtnvcatnmanageListTotCnt(ComtnvcatnmanageDefaultVO searchVO);
