...
public interface ComtnmtgplacemanageService {
	 ...
	 * @exception Exception
	 */
    List selectComtnmtgplacemanageList(ComtnmtgplacemanageDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectComtnmtgplacemanageListTotCnt(ComtnmtgplacemanageDefaultVO searchVO);
