...
public class ComtnintnetsvcDAO extends EgovAbstractDAO {
    ...
    public List selectComtnintnetsvcList(ComtnintnetsvcDefaultVO searchVO) throws Exception {
        return list("comtnintnetsvcDAO.selectComtnintnetsvcList_D", searchVO);
    }
    ...
    public int selectComtnintnetsvcListTotCnt(ComtnintnetsvcDefaultVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("comtnintnetsvcDAO.selectComtnintnetsvcListTotCnt_S", searchVO);
    }
