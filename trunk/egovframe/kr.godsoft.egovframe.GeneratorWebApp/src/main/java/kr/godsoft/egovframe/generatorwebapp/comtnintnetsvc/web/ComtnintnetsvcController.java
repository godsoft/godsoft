...
public class ComtnintnetsvcController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnintnetsvcVO
	 * @return "/comtnintnetsvc/ComtnintnetsvcList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnintnetsvc/ComtnintnetsvcList.do")
    public String selectComtnintnetsvcList(@ModelAttribute("searchVO") ComtnintnetsvcVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List<EgovMap> comtnintnetsvcList = comtnintnetsvcService.selectComtnintnetsvcList(searchVO);
