...
<%
 /**
  * @Class Name : ComthdbmntrngloginfoRegister.jsp
  * @Description : Comthdbmntrngloginfo Register 화면
...
<c:set var="registerFlag" value="${empty comthdbmntrngloginfoVO.dataSourcNm ? '등록' : '수정'}"/>
<title> <c:out value="${registerFlag}"/> </title>
<link type="text/css" rel="stylesheet" href="<c:url value='/css/egovframework/sample.css'/>"/>

<!--For Commons Validator Client Side-->
<!-- script type="text/javascript" src="<c:url value='/cmmn/validator.do'/>"></script -->
<!-- validator:javascript formName="comthdbmntrngloginfoVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/comthdbmntrngloginfo/ComthdbmntrngloginfoList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/comthdbmntrngloginfo/deleteComthdbmntrngloginfo.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/comthdbmntrngloginfo/addComthdbmntrngloginfo.do' : '/comthdbmntrngloginfo/updateComthdbmntrngloginfo.do'}"/>";
    frm.submit();
