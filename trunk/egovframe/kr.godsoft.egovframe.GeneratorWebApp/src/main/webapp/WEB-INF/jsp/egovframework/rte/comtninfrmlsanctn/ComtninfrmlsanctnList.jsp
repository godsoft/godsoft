...
<%
 /**
  * @Class Name : ComtninfrmlsanctnList.jsp
  * @Description : Comtninfrmlsanctn List 화면
...
<title>comtninfrmlsanctn 목록</title>
<link type="text/css" rel="stylesheet" href="<c:url value='/css/egovframework/sample.css'/>"/>
<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 수정 화면 function */
function fn_egov_select(infrmlSanctnId) {
	document.getElementById("listForm").infrmlSanctnId.value = infrmlSanctnId;
   	document.getElementById("listForm").action = "<c:url value='/comtninfrmlsanctn/updateComtninfrmlsanctnView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/comtninfrmlsanctn/addComtninfrmlsanctnView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/comtninfrmlsanctn/ComtninfrmlsanctnList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								...
								<th align="center">job_se_code</th>
			...
			<tr>
												...
												<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.infrmlSanctnId}"/>')"><c:out value="${result.infrmlSanctnId}"/></a>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.jobSeCode}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.applcntId}"/>&nbsp;</td>
