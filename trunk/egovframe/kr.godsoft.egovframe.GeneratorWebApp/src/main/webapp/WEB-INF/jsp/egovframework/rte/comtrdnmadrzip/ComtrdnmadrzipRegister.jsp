...
<c:set var="registerFlag" value="${empty comtrdnmadrzipVO.sn ? '등록' : '수정'}"/>
<title>comtrdnmadrzip <c:out value="${registerFlag}"/> </title>
...
<form:form commandName="comtrdnmadrzipVO" name="detailForm" id="detailForm">
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
