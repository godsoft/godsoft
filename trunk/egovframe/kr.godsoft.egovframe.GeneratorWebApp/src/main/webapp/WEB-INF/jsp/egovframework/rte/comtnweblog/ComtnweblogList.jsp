...
<%
 /**
  * @Class Name : ComtnweblogList.jsp
  * @Description : Comtnweblog List 화면
...
function fn_egov_select(requstId) {
	document.getElementById("listForm").requstId.value = requstId;
   	document.getElementById("listForm").action = "<c:url value='/comtnweblog/updateComtnweblogView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/comtnweblog/addComtnweblogView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/comtnweblog/ComtnweblogList.do'/>";
   	document.getElementById("listForm").submit();
}
