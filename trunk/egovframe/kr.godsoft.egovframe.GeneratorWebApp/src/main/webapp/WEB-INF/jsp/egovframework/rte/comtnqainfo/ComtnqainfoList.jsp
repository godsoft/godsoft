...
<%
 /**
  * @Class Name : ComtnqainfoList.jsp
  * @Description : Comtnqainfo List 화면
...
<!--
/* 글 수정 화면 function */
function fn_egov_select(qaId) {
	document.getElementById("listForm").qaId.value = qaId;
   	document.getElementById("listForm").action = "<c:url value='/comtnqainfo/updateComtnqainfoView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/comtnqainfo/addComtnqainfoView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/comtnqainfo/ComtnqainfoList.do'/>";
   	document.getElementById("listForm").submit();
}
...
<div id="content_pop">
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								<th align="center">QaId</th>
								<th align="center">QestnSj</th>
								<th align="center">QestnCn</th>
								...
								<th align="center">AnswerCn</th>
								<th align="center">WritngPassword</th>
								<th align="center">AnswerDe</th>
			...
			<tr>
												...
												<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.qaId}"/>')"><c:out value="${result.qaId}"/></a>&nbsp;</td>
																...
																<td align="center" class="listtd"><c:out value="${result.answerDe}"/>&nbsp;</td>
