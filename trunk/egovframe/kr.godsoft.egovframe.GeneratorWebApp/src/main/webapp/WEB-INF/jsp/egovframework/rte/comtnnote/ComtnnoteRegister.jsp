...
<%
 /**
  * @Class Name : ComtnnoteRegister.jsp
  * @Description : Comtnnote Register 화면
...
<!-- validator:javascript formName="comtnnoteVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/comtnnote/ComtnnoteList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/comtnnote/deleteComtnnote.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/comtnnote/addComtnnote.do' : '/comtnnote/updateComtnnote.do'}"/>";
    frm.submit();
