...
<%
 /**
  * @Class Name : ComtnprocessmonList.jsp
  * @Description : Comtnprocessmon List 화면
...
<title>comtnprocessmon 목록</title>
<link type="text/css" rel="stylesheet" href="<c:url value='/css/egovframework/sample.css'/>"/>
<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 수정 화면 function */
function fn_egov_select(procsId) {
	document.getElementById("listForm").procsId.value = procsId;
   	document.getElementById("listForm").action = "<c:url value='/comtnprocessmon/updateComtnprocessmonView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/comtnprocessmon/addComtnprocessmonView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/comtnprocessmon/ComtnprocessmonList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
												...
												<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.procsId}"/>')"><c:out value="${result.procsId}"/></a>&nbsp;</td>
