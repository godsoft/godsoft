...
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/comtnprogrmlist/ComtnprogrmlistList.do'/>";
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/comtnprogrmlist/addComtnprogrmlist.do' : '/comtnprogrmlist/updateComtnprogrmlist.do'}"/>";
    frm.submit();
