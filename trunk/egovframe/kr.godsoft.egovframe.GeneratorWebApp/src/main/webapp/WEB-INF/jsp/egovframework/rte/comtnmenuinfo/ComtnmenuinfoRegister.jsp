...
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/comtnmenuinfo/ComtnmenuinfoList.do'/>";
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/comtnmenuinfo/addComtnmenuinfo.do' : '/comtnmenuinfo/updateComtnmenuinfo.do'}"/>";
    frm.submit();
