...
<%
 /**
  * @Class Name : ComtnprocessmonloginfoList.jsp
  * @Description : Comtnprocessmonloginfo List 화면
...
<!--
/* 글 수정 화면 function */
function fn_egov_select(procsId, logId) {
	document.getElementById("listForm").procsId.value = procsId;
	document.getElementById("listForm").logId.value = logId;
   	document.getElementById("listForm").action = "<c:url value='/comtnprocessmonloginfo/updateComtnprocessmonloginfoView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/comtnprocessmonloginfo/addComtnprocessmonloginfoView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/comtnprocessmonloginfo/ComtnprocessmonloginfoList.do'/>";
   	document.getElementById("listForm").submit();
}
