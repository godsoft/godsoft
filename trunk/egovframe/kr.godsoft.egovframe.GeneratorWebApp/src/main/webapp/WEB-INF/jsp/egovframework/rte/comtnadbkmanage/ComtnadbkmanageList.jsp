...
<%
 /**
  * @Class Name : ComtnadbkmanageList.jsp
  * @Description : Comtnadbkmanage List 화면
...
<!--
/* 글 수정 화면 function */
function fn_egov_select(adbkId) {
	document.getElementById("listForm").adbkId.value = adbkId;
   	document.getElementById("listForm").action = "<c:url value='/comtnadbkmanage/updateComtnadbkmanageView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/comtnadbkmanage/addComtnadbkmanageView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/comtnadbkmanage/ComtnadbkmanageList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
												...
												<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.adbkId}"/>')"><c:out value="${result.adbkId}"/></a>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.adbkNm}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.othbcScope}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.useAt}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.wrterId}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.trgetOrgnztId}"/>&nbsp;</td>
