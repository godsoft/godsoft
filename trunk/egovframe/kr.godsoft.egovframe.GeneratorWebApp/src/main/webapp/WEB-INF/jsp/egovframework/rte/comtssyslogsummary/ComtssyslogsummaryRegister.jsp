...
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/comtssyslogsummary/ComtssyslogsummaryList.do'/>";
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/comtssyslogsummary/addComtssyslogsummary.do' : '/comtssyslogsummary/updateComtssyslogsummary.do'}"/>";
    frm.submit();
