...
<%
 /**
  * @Class Name : MdSequencesList.jsp
  * @Description : MdSequences List 화면
...
<title>For storing information on sequences. 목록</title>
...
function fn_egov_select(id) {
	document.getElementById("listForm").id.value = id;
   	document.getElementById("listForm").action = "<c:url value='/mdSequences/updateMdSequencesView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/mdSequences/addMdSequencesView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/mdSequences/MdSequencesList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								...
								<th align="center">Name of this sequence //OBJECTNAME</th>
								<th align="center">Starting point of the sequence</th>
								<th align="center">Increment value of the sequence</th>
								<th align="center">SQL used to create this object at source</th>
								<th align="center">Identifier for this object at source.</th>
			...
			<tr>
												...
												<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.id}"/>')"><c:out value="${result.id}"/></a>&nbsp;</td>
																...
																<td align="center" class="listtd"><c:out value="${result.seqStart}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.incr}"/>&nbsp;</td>
