...
<c:set var="registerFlag" value="${empty comtnbatchschdulVO.batchSchdulId ? '등록' : '수정'}"/>
<title>comtnbatchschdul <c:out value="${registerFlag}"/> </title>
...
<form:form commandName="comtnbatchschdulVO" name="detailForm" id="detailForm">
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
