...
<%
 /**
  * @Class Name : ComtnuserabsnceList.jsp
  * @Description : Comtnuserabsnce List 화면
...
<title>comtnuserabsnce 목록</title>
...
function fn_egov_select(emplyrId) {
	document.getElementById("listForm").emplyrId.value = emplyrId;
   	document.getElementById("listForm").action = "<c:url value='/comtnuserabsnce/updateComtnuserabsnceView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/comtnuserabsnce/addComtnuserabsnceView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/comtnuserabsnce/ComtnuserabsnceList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								...
								<th align="center">user_absnce_at</th>
			...
			<tr>
												...
												<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.emplyrId}"/>')"><c:out value="${result.emplyrId}"/></a>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.userAbsnceAt}"/>&nbsp;</td>
