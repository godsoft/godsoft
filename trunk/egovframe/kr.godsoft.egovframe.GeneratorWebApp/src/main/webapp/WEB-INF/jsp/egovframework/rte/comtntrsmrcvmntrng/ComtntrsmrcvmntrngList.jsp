...
<%
 /**
  * @Class Name : ComtntrsmrcvmntrngList.jsp
  * @Description : Comtntrsmrcvmntrng List 화면
...
<title>comtntrsmrcvmntrng 목록</title>
...
function fn_egov_select(cntcId) {
	document.getElementById("listForm").cntcId.value = cntcId;
   	document.getElementById("listForm").action = "<c:url value='/comtntrsmrcvmntrng/updateComtntrsmrcvmntrngView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/comtntrsmrcvmntrng/addComtntrsmrcvmntrngView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/comtntrsmrcvmntrng/ComtntrsmrcvmntrngList.do'/>";
   	document.getElementById("listForm").submit();
}
