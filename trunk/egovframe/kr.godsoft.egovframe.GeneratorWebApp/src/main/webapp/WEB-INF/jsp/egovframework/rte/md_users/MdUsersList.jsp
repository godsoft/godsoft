...
<%
 /**
  * @Class Name : MdUsersList.jsp
  * @Description : MdUsers List 화면
...
<title>User information. 목록</title>
...
function fn_egov_select(id) {
	document.getElementById("listForm").id.value = id;
   	document.getElementById("listForm").action = "<c:url value='/mdUsers/updateMdUsersView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/mdUsers/addMdUsersView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/mdUsers/MdUsersList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								...
								<th align="center">Shema in which this object belongs //PARENTFIELD</th>
								<th align="center">Username for login //OBJECTNAME</th>
								<th align="center">Password for login</th>
