...
<%
 /**
  * @Class Name : ComtstrsmrcvlogsummaryRegister.jsp
  * @Description : Comtstrsmrcvlogsummary Register 화면
...
<!-- validator:javascript formName="comtstrsmrcvlogsummaryVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/comtstrsmrcvlogsummary/ComtstrsmrcvlogsummaryList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/comtstrsmrcvlogsummary/deleteComtstrsmrcvlogsummary.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/comtstrsmrcvlogsummary/addComtstrsmrcvlogsummary.do' : '/comtstrsmrcvlogsummary/updateComtstrsmrcvlogsummary.do'}"/>";
    frm.submit();
