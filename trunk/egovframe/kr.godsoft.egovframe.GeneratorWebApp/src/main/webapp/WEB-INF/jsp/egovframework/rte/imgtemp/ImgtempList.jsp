...
<%
 /**
  * @Class Name : ImgtempList.jsp
  * @Description : Imgtemp List 화면
...
<!--
/* 글 수정 화면 function */
function fn_egov_select(orgnztCode, erncslSe) {
	document.getElementById("listForm").orgnztCode.value = orgnztCode;
	document.getElementById("listForm").erncslSe.value = erncslSe;
   	document.getElementById("listForm").action = "<c:url value='/imgtemp/updateImgtempView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/imgtemp/addImgtempView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/imgtemp/ImgtempList.do'/>";
   	document.getElementById("listForm").submit();
}
