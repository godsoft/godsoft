...
<%
 /**
  * @Class Name : ComtnbackupschduldfkRegister.jsp
  * @Description : Comtnbackupschduldfk Register 화면
...
<!-- validator:javascript formName="comtnbackupschduldfkVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/comtnbackupschduldfk/ComtnbackupschduldfkList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/comtnbackupschduldfk/deleteComtnbackupschduldfk.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/comtnbackupschduldfk/addComtnbackupschduldfk.do' : '/comtnbackupschduldfk/updateComtnbackupschduldfk.do'}"/>";
    frm.submit();
