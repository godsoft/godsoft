...
<%
 /**
  * @Class Name : ComtntwitterList.jsp
  * @Description : Comtntwitter List 화면
...
function fn_egov_select(userId) {
	document.getElementById("listForm").userId.value = userId;
   	document.getElementById("listForm").action = "<c:url value='/comtntwitter/updateComtntwitterView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/comtntwitter/addComtntwitterView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/comtntwitter/ComtntwitterList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								...
								<th align="center">cnsmr_key</th>
								<th align="center">cnsmr_secret</th>
			...
			<tr>
												...
												<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.userId}"/>')"><c:out value="${result.userId}"/></a>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.cnsmrKey}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.cnsmrSecret}"/>&nbsp;</td>
