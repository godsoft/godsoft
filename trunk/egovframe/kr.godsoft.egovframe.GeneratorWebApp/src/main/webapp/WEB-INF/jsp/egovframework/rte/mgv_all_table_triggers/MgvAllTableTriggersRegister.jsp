...
<%
 /**
  * @Class Name : MgvAllTableTriggersRegister.jsp
  * @Description : MgvAllTableTriggers Register 화면
...
<title>mgv_all_table_triggers <c:out value="${registerFlag}"/> </title>
<link type="text/css" rel="stylesheet" href="<c:url value='/css/egovframework/sample.css'/>"/>

<!--For Commons Validator Client Side-->
<!-- script type="text/javascript" src="<c:url value='/cmmn/validator.do'/>"></script -->
<!-- validator:javascript formName="mgvAllTableTriggersVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/mgvAllTableTriggers/MgvAllTableTriggersList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/mgvAllTableTriggers/deleteMgvAllTableTriggers.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/mgvAllTableTriggers/addMgvAllTableTriggers.do' : '/mgvAllTableTriggers/updateMgvAllTableTriggers.do'}"/>";
    frm.submit();
...
<form:form commandName="mgvAllTableTriggersVO" name="detailForm" id="detailForm">
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
