...
<%
 /**
  * @Class Name : ComtnmemoreprtList.jsp
  * @Description : Comtnmemoreprt List 화면
...
function fn_egov_select(reprtId) {
	document.getElementById("listForm").reprtId.value = reprtId;
   	document.getElementById("listForm").action = "<c:url value='/comtnmemoreprt/updateComtnmemoreprtView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/comtnmemoreprt/addComtnmemoreprtView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/comtnmemoreprt/ComtnmemoreprtList.do'/>";
   	document.getElementById("listForm").submit();
}
...
<div id="content_pop">
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								<th align="center">ReprtSj</th>
								<th align="center">ReportDe</th>
								<th align="center">WrterId</th>
								<th align="center">ReportrId</th>
								<th align="center">ReportCn</th>
								<th align="center">AtchFileId</th>
								<th align="center">DrctMatter</th>
								<th align="center">DrctMatterRegistDt</th>
								<th align="center">ReportrInqireDt</th>
			...
			<tr>
												...
												<td align="center" class="listtd"><c:out value="${result.reprtSj}"/>&nbsp;</td>
																...
																<td align="center" class="listtd"><c:out value="${result.reportCn}"/>&nbsp;</td>
																...
																<td align="center" class="listtd"><c:out value="${result.drctMatterRegistDt}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.reportrInqireDt}"/>&nbsp;</td>
