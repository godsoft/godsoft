...
<%
 /**
  * @Class Name : ComtninsttcoderecptnlogRegister.jsp
  * @Description : Comtninsttcoderecptnlog Register 화면
...
<c:set var="registerFlag" value="${empty comtninsttcoderecptnlogVO.insttCode ? '등록' : '수정'}"/>
<c:set var="registerFlag" value="${empty comtninsttcoderecptnlogVO.opertSn ? '등록' : '수정'}"/>
<title>comtninsttcoderecptnlog <c:out value="${registerFlag}"/> </title>
<link type="text/css" rel="stylesheet" href="<c:url value='/css/egovframework/sample.css'/>"/>

<!--For Commons Validator Client Side-->
<!-- script type="text/javascript" src="<c:url value='/cmmn/validator.do'/>"></script -->
<!-- validator:javascript formName="comtninsttcoderecptnlogVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/comtninsttcoderecptnlog/ComtninsttcoderecptnlogList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/comtninsttcoderecptnlog/deleteComtninsttcoderecptnlog.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/comtninsttcoderecptnlog/addComtninsttcoderecptnlog.do' : '/comtninsttcoderecptnlog/updateComtninsttcoderecptnlog.do'}"/>";
    frm.submit();
