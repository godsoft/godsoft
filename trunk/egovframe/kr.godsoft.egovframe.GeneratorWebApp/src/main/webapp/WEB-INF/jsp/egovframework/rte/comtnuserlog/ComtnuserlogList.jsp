	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
												...
												<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.occrrncDe}"/>, <c:out value="{D}{result.rqesterId}"/>, <c:out value="{D}{result.svcNm}"/>, <c:out value="{D}{result.methodNm}"/>')"><c:out value="${result.occrrncDe}"/></a>&nbsp;</td>
																<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.occrrncDe}"/>, <c:out value="{D}{result.rqesterId}"/>, <c:out value="{D}{result.svcNm}"/>, <c:out value="{D}{result.methodNm}"/>')"><c:out value="${result.rqesterId}"/></a>&nbsp;</td>
																<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.occrrncDe}"/>, <c:out value="{D}{result.rqesterId}"/>, <c:out value="{D}{result.svcNm}"/>, <c:out value="{D}{result.methodNm}"/>')"><c:out value="${result.svcNm}"/></a>&nbsp;</td>
																<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.occrrncDe}"/>, <c:out value="{D}{result.rqesterId}"/>, <c:out value="{D}{result.svcNm}"/>, <c:out value="{D}{result.methodNm}"/>')"><c:out value="${result.methodNm}"/></a>&nbsp;</td>
