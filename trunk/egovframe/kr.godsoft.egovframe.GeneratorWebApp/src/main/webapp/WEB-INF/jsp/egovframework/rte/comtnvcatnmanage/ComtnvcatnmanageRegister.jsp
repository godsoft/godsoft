...
<c:set var="registerFlag" value="${empty comtnvcatnmanageVO.applcntId ? '등록' : '수정'}"/>
<c:set var="registerFlag" value="${empty comtnvcatnmanageVO.vcatnSe ? '등록' : '수정'}"/>
<c:set var="registerFlag" value="${empty comtnvcatnmanageVO.bgnde ? '등록' : '수정'}"/>
<c:set var="registerFlag" value="${empty comtnvcatnmanageVO.endde ? '등록' : '수정'}"/>
<title>comtnvcatnmanage <c:out value="${registerFlag}"/> </title>
...
<form:form commandName="comtnvcatnmanageVO" name="detailForm" id="detailForm">
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
