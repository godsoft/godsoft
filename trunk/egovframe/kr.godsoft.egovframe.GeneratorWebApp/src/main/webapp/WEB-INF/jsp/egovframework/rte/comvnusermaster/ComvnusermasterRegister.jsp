...
<%
 /**
  * @Class Name : ComvnusermasterRegister.jsp
  * @Description : Comvnusermaster Register 화면
...
<!-- validator:javascript formName="comvnusermasterVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/comvnusermaster/ComvnusermasterList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/comvnusermaster/deleteComvnusermaster.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/comvnusermaster/addComvnusermaster.do' : '/comvnusermaster/updateComvnusermaster.do'}"/>";
    frm.submit();
...
<form:form commandName="comvnusermasterVO" name="detailForm" id="detailForm">
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
