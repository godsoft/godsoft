...
<%
 /**
  * @Class Name : ComtnloginpolicyList.jsp
  * @Description : Comtnloginpolicy List 화면
...
<title>comtnloginpolicy 목록</title>
...
function fn_egov_select(emplyrId) {
	document.getElementById("listForm").emplyrId.value = emplyrId;
   	document.getElementById("listForm").action = "<c:url value='/comtnloginpolicy/updateComtnloginpolicyView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/comtnloginpolicy/addComtnloginpolicyView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/comtnloginpolicy/ComtnloginpolicyList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								...
								<th align="center">ip_info</th>
								<th align="center">dplct_perm_at</th>
								<th align="center">lmtt_at</th>
			...
			<tr>
												...
												<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.emplyrId}"/>')"><c:out value="${result.emplyrId}"/></a>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.ipInfo}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.dplctPermAt}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.lmttAt}"/>&nbsp;</td>
