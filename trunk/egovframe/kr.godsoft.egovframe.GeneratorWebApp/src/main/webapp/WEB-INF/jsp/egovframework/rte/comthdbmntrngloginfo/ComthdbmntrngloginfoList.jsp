...
<%
 /**
  * @Class Name : ComthdbmntrngloginfoList.jsp
  * @Description : Comthdbmntrngloginfo List 화면
...
<title>comthdbmntrngloginfo 목록</title>
...
function fn_egov_select(logId) {
	document.getElementById("listForm").logId.value = logId;
   	document.getElementById("listForm").action = "<c:url value='/comthdbmntrngloginfo/updateComthdbmntrngloginfoView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/comthdbmntrngloginfo/addComthdbmntrngloginfoView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/comthdbmntrngloginfo/ComthdbmntrngloginfoList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
												...
												<td align="center" class="listtd"><c:out value="${result.dataSourcNm}"/>&nbsp;</td>
