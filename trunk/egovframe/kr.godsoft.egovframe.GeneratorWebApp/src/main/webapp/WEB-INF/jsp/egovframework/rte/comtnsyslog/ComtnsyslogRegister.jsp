...
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/comtnsyslog/ComtnsyslogList.do'/>";
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/comtnsyslog/addComtnsyslog.do' : '/comtnsyslog/updateComtnsyslog.do'}"/>";
    frm.submit();
