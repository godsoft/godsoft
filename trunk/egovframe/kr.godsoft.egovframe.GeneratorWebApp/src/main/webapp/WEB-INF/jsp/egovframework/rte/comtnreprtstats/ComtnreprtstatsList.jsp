...
<%
 /**
  * @Class Name : ComtnreprtstatsList.jsp
  * @Description : Comtnreprtstats List 화면
...
<title>comtnreprtstats 목록</title>
...
function fn_egov_select(reprtId) {
	document.getElementById("listForm").reprtId.value = reprtId;
   	document.getElementById("listForm").action = "<c:url value='/comtnreprtstats/updateComtnreprtstatsView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/comtnreprtstats/addComtnreprtstatsView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/comtnreprtstats/ComtnreprtstatsList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								...
								<th align="center">reprt_nm</th>
								<th align="center">reprt_sttus</th>
			...
			<tr>
												...
												<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.reprtId}"/>')"><c:out value="${result.reprtId}"/></a>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.reprtNm}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.reprtSttus}"/>&nbsp;</td>
																...
																<td align="center" class="listtd"><c:out value="${result.reprtTy}"/>&nbsp;</td>
											</tr>
			</c:forEach>
		</table>
	</div>
