...
<c:set var="registerFlag" value="${empty comtnncrdVO.ncrdId ? '등록' : '수정'}"/>
<title>comtnncrd <c:out value="${registerFlag}"/> </title>
...
<form:form commandName="comtnncrdVO" name="detailForm" id="detailForm">
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
