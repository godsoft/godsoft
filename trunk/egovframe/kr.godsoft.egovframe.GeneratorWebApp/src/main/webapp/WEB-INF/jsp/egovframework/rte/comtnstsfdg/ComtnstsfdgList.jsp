...
<%
 /**
  * @Class Name : ComtnstsfdgList.jsp
  * @Description : Comtnstsfdg List 화면
...
<!--
/* 글 수정 화면 function */
function fn_egov_select(stsfdgNo) {
	document.getElementById("listForm").stsfdgNo.value = stsfdgNo;
   	document.getElementById("listForm").action = "<c:url value='/comtnstsfdg/updateComtnstsfdgView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/comtnstsfdg/addComtnstsfdgView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/comtnstsfdg/ComtnstsfdgList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
												...
												<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.stsfdgNo}"/>')"><c:out value="${result.stsfdgNo}"/></a>&nbsp;</td>
																...
																<td align="center" class="listtd"><c:out value="${result.stsfdg}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.stsfdgCn}"/>&nbsp;</td>
