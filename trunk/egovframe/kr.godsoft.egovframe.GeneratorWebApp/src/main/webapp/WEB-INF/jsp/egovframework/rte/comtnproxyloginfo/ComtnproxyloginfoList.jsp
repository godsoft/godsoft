...
<%
 /**
  * @Class Name : ComtnproxyloginfoList.jsp
  * @Description : Comtnproxyloginfo List 화면
...
<!--
/* 글 수정 화면 function */
function fn_egov_select(proxyId, logId) {
	document.getElementById("listForm").proxyId.value = proxyId;
	document.getElementById("listForm").logId.value = logId;
   	document.getElementById("listForm").action = "<c:url value='/comtnproxyloginfo/updateComtnproxyloginfoView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/comtnproxyloginfo/addComtnproxyloginfoView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/comtnproxyloginfo/ComtnproxyloginfoList.do'/>";
   	document.getElementById("listForm").submit();
}
