...
<%
 /**
  * @Class Name : MdGroupsList.jsp
  * @Description : MdGroups List 화면
...
<title>Groups of users in a schema 목록</title>
...
function fn_egov_select(id) {
	document.getElementById("listForm").id.value = id;
   	document.getElementById("listForm").action = "<c:url value='/mdGroups/updateMdGroupsView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/mdGroups/addMdGroupsView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/mdGroups/MdGroupsList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								...
								<th align="center">Schema in which this object belongs //PARENTFIELD</th>
								<th align="center">Name of the group //OBJECTNAME</th>
								<th align="center">This is a flag to signify a group or a role.  If this is 'R' it means the group is known as a Role.  Any other value means it is known as a group.</th>
								<th align="center">SQL Used to generate this object at source</th>
								<th align="center">Unique id for this object at source</th>
			...
			<tr>
												...
												<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.id}"/>')"><c:out value="${result.id}"/></a>&nbsp;</td>
																...
																<td align="center" class="listtd"><c:out value="${result.groupName}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.groupFlag}"/>&nbsp;</td>
