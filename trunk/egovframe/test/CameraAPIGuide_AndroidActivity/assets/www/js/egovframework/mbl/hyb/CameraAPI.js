...
$(function(){
    ...
    $("#listPhotoAlbum").live("pageshow", function(event, ui){
    ...
    $("#addPhotoAlbum").live("pageshow", function(event, ui){
        
    });
    
    $("#detailPhotoAlbum").live("pageshow", function(event, ui){
        
        if(myScroll != null) {
            
            myScroll.destroy();
        }
        loaded('wrapper_imageDetail');
    });
    
    $("#listPhotoAlbum").live("pagehide", function(event, ui){
        
        $("#photoAlbumList").html("");
    });
    
    $("#detailPhotoAlbum").live("pagehide", function(event, ui){
        
        currentImageSn = "";
    });
    
    $("#addPhotoAlbum").live("pagehide", function(event, ui){
