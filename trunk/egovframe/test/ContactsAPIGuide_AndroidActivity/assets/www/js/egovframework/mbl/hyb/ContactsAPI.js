...
$(function() 
{
    ...
    $("#contactList").live("pageshow", function(event, ui){
...
function fn_egov_move_contactBackup() {
    ...
    $.mobile.showPageLoadingMsg('a');
    var fields = ["*"];
    navigator.contacts.find(fields, fn_egov_contactBackupCountSuccess, fn_egov_fail);
}
...
function fn_egov_move_contactRecovery() {
    ...
    $.mobile.showPageLoadingMsg('a');
    var fields = ["*"];
    navigator.contacts.find(fields, fn_egov_contactRecoveryCountSuccess, fn_egov_fail);
}
