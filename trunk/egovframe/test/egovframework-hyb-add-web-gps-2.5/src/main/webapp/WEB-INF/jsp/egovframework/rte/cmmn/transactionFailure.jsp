...
<html> 
    <head>
        ...
        <link rel="stylesheet" href="/css/egovframework/mbl/cmm/jquery.mobile-1.0b1.min.css"/>
        <link rel="stylesheet" href="/css/egovframework/mbl/cmm/EgovMobile.css" />
        <script src="/js/egovframework/mbl/cmm/jquery-1.6.1.min.js"></script>
        <script src="/js/egovframework/mbl/cmm/EgovMobile.js"></script>
        <script type="text/javascript" src="/js/egovframework/mbl/cmm/jquery.mobile-1.0b1.min.js"></script>
