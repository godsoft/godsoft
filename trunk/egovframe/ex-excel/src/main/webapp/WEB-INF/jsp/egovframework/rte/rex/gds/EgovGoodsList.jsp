...
<input type="hidden" name="selectedId" />
	...
	<div id="paging">
		...
		<div id="sysbtn">
		<ul>
			<li><span class="btn_blue_l" title="excel"><a href="#link" onClick="fn_egov_excel(); return false;">excel</a><img src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>" style="margin-left:6px;" alt="excel"/></span></li>
