...
//    
//    private static final Logger LOG = Logger.getLogger(EgovSmsInfoController.class.getClass());
//    
//    /**
//     * 문자메시지 목록을 조회한다.
//     * 
...
//
//	    smsVO.setUniqId(user.getUniqId());
//
...
//	
//	if (isAuthenticated) {
//	    sms.setFrstRegisterId(user.getUniqId());
//
