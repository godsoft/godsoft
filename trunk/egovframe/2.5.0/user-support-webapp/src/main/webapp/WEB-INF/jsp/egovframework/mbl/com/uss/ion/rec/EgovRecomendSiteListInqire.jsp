	...
	<head>
		...
		<script type="text/javaScript" language="javascript" defer="defer">
			...
			function initList() {
       			...
       			$.getJSON("${pageContext.request.contextPath}/uss/ion/rec/RecomendSiteListInqireActor.mdo", $('#searchVO').serialize(), function(json){
	...
	<body>
		...
		<div id="list" data-role="page">
			...
			<div data-role="header">
				<a href="${pageContext.request.contextPath}/uat/uia/actionMain.mdo" data-icon="home" rel="external">홈</a>
			    <h1>추천사이트 목록조회</h1>
			</div>
			<!-- header end -->
