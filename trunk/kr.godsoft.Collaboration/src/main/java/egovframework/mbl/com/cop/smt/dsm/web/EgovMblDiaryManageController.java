...
public class EgovMblDiaryManageController {
    ...
    throws Exception {
        ...
        if(commandMap.get("schdulId") != null && "save".equals(((String)commandMap.get("schdulId")))){ 
    ...
    throws Exception {
        ...
        if(sCmd.equals("save")){
        	...
        	// 아이디설정
			****************************************************************** */
    		diaryManageVO.setFrstRegisterId((String)loginVO.getUniqId());
    		diaryManageVO.setLastUpdusrId((String)loginVO.getUniqId());
    		/* *****************************************************************
        	// 첨부파일 관련 ID 생성 start....
			****************************************************************** */
    ...
    throws Exception {
    	...
    	if("SCHDUL_SE".equals(((String)commandMap.get("searchCondition")))) {
