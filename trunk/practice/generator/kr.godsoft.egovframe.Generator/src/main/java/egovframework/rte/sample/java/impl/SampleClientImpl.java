package egovframework.rte.sample.java.impl;
...
public class SampleClientImpl implements SampleClient {
	...
	private static Log log = LogFactory.getLog(SampleClientImpl.class);
	...
	public static void main(String[] args) {
		SampleClientImpl sampleClient = new SampleClientImpl();
