			...
			<div data-role="content" class="com-ussContent">
				...
				<div data-inline="true">
					<dl class="uss-registOk">
						...
						<dd class="department">
							<div>
								<span class="uss-dataBox"><form:input path="schdulBgndeYYYMMDD" type="text" data-role="datebox" readonly="true" /></span>
				        		<span class="uss-dataBox"><form:input path="schdulBgndeHH" type="text" data-role="datebox" data-options='{"mode": "timebox"}' readonly="true" /></span>
							</div>
							<div class="uss-time">
			        			<span class="uss-dataBox"><form:input path="schdulEnddeYYYMMDD" type="text" data-role="datebox" readonly="true" /></span>
				        		<span class="uss-dataBox"><form:input path="schdulEnddeHH" type="text" data-role="datebox" data-options='{"mode": "timebox"}' readonly="true" /></span>
			        		</div>
						</dd>
