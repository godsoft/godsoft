						...
						<c:choose>
						  	<c:when test="${brdMstrVO.bbsAttrbCode == 'BBSA01'}"> 
								<div class="uss-regist" data-inline="true">
					        		...
					        		<input name="ntceBgnde" id="defandroid" type="date"  data-role="datebox"  readonly="true" >
								</div>
								<div class="uss-regist" data-inline="true">
									<label for="ntceEndde">종료일자</label><br>
						        	<input name="ntceEndde" id="defandroid" type="date"  data-role="datebox"  readonly="true" >
								</div>
							</c:when>
