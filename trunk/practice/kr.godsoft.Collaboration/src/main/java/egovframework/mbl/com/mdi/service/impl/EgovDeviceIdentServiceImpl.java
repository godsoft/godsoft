...
public class EgovDeviceIdentServiceImpl extends AbstractServiceImpl implements
    ...
    public void insertDeviceIdent(DeviceIdent deviceIdent) throws Exception {
        ...
        log.debug(deviceIdent.toString());
     ...
     * @throws Exception
     */
    public DeviceIdent selectDeviceIdent(DeviceIdent deviceIdent)
            throws Exception {
        DeviceIdent ret =
            (DeviceIdent) deviceIdentDAO.selectDeviceIdent(deviceIdent);
        return ret;
    }
     ...
     * @return int
     */
    public int selectDeviceIdentListTotCnt(DeviceIdentVO searchVO)
            throws Exception {
