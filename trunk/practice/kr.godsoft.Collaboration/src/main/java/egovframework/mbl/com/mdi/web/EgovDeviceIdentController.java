...
public class EgovDeviceIdentController {
    ...
    public ModelAndView selectMobileDeviceIdentList(ModelMap model,
        ...
        DeviceIdent deviceIdent =
            deviceIdentService.getDeviceIdentFromXML(uagentInfo);
    ...
    public String goDeviceIdentRegist(
            @ModelAttribute("searchVO") DeviceIdentVO searchVO, ModelMap model)
            throws Exception {
        ...
        model.addAttribute("browserCmmCodeDetailList",
            getCmmCodeDetailList("COM083"));
        model.addAttribute("osCmmCodeDetailList",
            getCmmCodeDetailList("COM084"));
    ...
    public String insertDeviceIdent(
            ...
            @ModelAttribute("searchVO") DeviceIdentVO searchVO,
            @ModelAttribute("deviceIdent") DeviceIdent deviceIdent,
    ...
    public String selectDeviceIdentList(
            @ModelAttribute("searchVO") DeviceIdentVO searchVO, ModelMap model)
            throws Exception {
        ...
        List deviceIdentList =
            deviceIdentService.selectDeviceIdentList(searchVO);
    ...
    public String selectDeviceIdent(
            @ModelAttribute("searchVO") DeviceIdentVO searchVO,
            DeviceIdent deviceIdent, ModelMap model) throws Exception {
    ...
    public String goDeviceIdentUpdt(
            @ModelAttribute("searchVO") DeviceIdentVO searchVO,
            DeviceIdent deviceIdent, ModelMap model) throws Exception {
    ...
    public String deleteDeviceIdent(
            @ModelAttribute("searchVO") DeviceIdentVO deviceIdentVO,
            DeviceIdent deviceIdent) throws Exception {
