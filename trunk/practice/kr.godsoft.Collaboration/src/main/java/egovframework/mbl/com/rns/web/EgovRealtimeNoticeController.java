...
public class EgovRealtimeNoticeController {
	...
	public ModelAndView goEvent(HttpServletRequest req, HttpServletResponse res, Model model) throws IOException {
	...
	public ModelAndView goRealtimeNoticeList(
        ...
        if(!isAuthenticated) {
            modelAndView.setViewName("egovframework/com/uat/uia/EgovLoginUsr");
            return modelAndView;
        }
	...
	public ModelAndView selectRealtimeNotice(@ModelAttribute("searchVO") RealtimeNoticeVO searchVO, 
		...
		RealtimeNotice oRealtimeNotice = (RealtimeNotice)realtimeNoticeService.selectRealtimeNotice(searchVO);
