...
<table width="100%" cellpadding="8" class="table-search" border="0" summary="상단 타이틀을 제공한다.">
 <tr>
  <td width="100%"class="title_left">
   <img src="${ImgUrl}icon/tit_icon.gif" width="16" height="16" hspace="3" align="middle" alt="최근검색어관리 수정">&nbsp;최근검색어관리 수정</td>
 </tr>
</table>
<!--  줄간격조정  -->
...
<!--  등록  폼 영역  -->
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary=" 수정을 제공한다.">
