  ...
  <th width="70px" align="center">
   <table border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
      ...
      <td>&nbsp;</td>
      <!--
      <td><img src="<c:out value="${ImgUrl}" />button/bu2_left.gif" width="8" height="20" alt="버튼이미지"></td>
...
<tr>
    ...
    <td class="lt_text3"><a href="JavaScript:fn_egov_delete_RecentSrchwrd('${resultInfo.srchwrdId}')">삭제</a></td>
</tr>
</c:forEach>
</tbody>
</table>
