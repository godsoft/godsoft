...
<!-- 행정안전부 로고 및 타이틀 시작 -->
<div id="logoarea">
    <h1><a href="<c:url value='/cmm/main/mainPage.do' />"><img src="<c:url value='/images/header/limg_lt_pas_logo.gif' />" alt="행정안전부" /></a></h1>
</div>
<div id="nia_logo">
    <img src="<c:url value='/images/header/limg_lt_nia_logo.gif' />" alt="NIA한국정보화진흥원" />
</div>
<div id="project_title"><span class="maintitle">표준프레임워크 </span><strong>경량환경 홈페이지 </strong>
</div>
<!-- //행정안전부 로고 및 타이틀 끝 -->
