                ...
                <div class="search_top_table">                  
                    <table summary="이 표는 약관내용 대상 정보를 제공하며, 이용약관명, 이용약관내용, 정보제공동의내용 정보로 구성되어 있습니다 .">
                        ...
                        <tr>
                            ...
                            <td class="td_content">
                            <textarea name="useStplatCn" id="useStplatCn" class="textarea" title="이용약관내용" cols="100" rows="20"><c:out value="${result.useStplatCn}"/>
                            </textarea>            
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="td_content">
                            <textarea name="infoProvdAgreCn" id="infoProvdAgreCn" class="textarea" title="정보제공동의내용" cols="100" rows="20"><c:out value="${result.infoProvdAgreCn}"/>
                            </textarea>
                            </td>
                        </tr>
                    </table>
