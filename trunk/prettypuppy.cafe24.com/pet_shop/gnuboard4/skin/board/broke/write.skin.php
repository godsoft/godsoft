...
<tr>
    ...
    <td><select name=ca_name required itemname="분류" onchange="document.getElementById('wr_subject').value = this.value; document.getElementById('wr_content').focus();"><option value="">선택하세요<?=$category_option?></select></td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
<? } ?>
