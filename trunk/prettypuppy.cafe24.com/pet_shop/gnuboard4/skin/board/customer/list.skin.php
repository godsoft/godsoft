...
?>
<? if ($admin_href) { ?>
<a href="<?php echo $g4['path']; ?>/skin/board/sale/calendar.php" target="_blank">판매 달력</a>
<?}?>
<?php
}
?>
<a href="<?php echo $g4['path']; ?>/skin/board/sale/calendar.php" target="_blank">.</a>
...
<h1>
<a href="<?php echo $g4['path']; ?>/bbs/board.php?bo_table=broke" target="_blank">용품</a>
</h1>
...
?>
            ...
            <option value="wr_<?php echo $i; ?>"><?php echo $board['bo_' . $i . '_subj']; ?></option>
