...
<?php
$customer_wr_id = sprintf('%010d', $wr_id);
?>
...
<div style="clear:both; height:30px;">
    ...
    <!-- <a href="board.php?bo_table=pet&sca=&sfl=wr_1&stx=<?php echo $customer_wr_id; ?>&x=30&y=12&sop=and" target="_blank"><input type="button" value="애견 목록" /></a>
    <a href="write.php?bo_table=pet&wr_1=<?php echo $customer_wr_id; ?>" target="_blank"><input type="button" value="애견 등록" /></a> -->

    <a href="board.php?bo_table=pet&sca=&sfl=wr_1&stx=<?php echo $customer_wr_id; ?>&x=30&y=12&sop=and" target="_blank">애견목록</a>
    | <a href="write.php?bo_table=pet&wr_1=<?php echo $customer_wr_id; ?>" target="_blank">애견등록</a>
...
<tr>
    <td height="150" style="word-break:break-all; padding:10px;">
        ...
        <?php if (empty($write['wr_4']) == false) { ?><p><img src="<?php echo $write['wr_4']; ?>"/></p><?php } ?>
        <?php if (empty($write['wr_5']) == false) { ?><p><img src="<?php echo $write['wr_5']; ?>"/></p><?php } ?>
        <?php if (empty($write['wr_6']) == false) { ?><p><img src="<?php echo $write['wr_6']; ?>"/></p><?php } ?>
        <?php if (empty($write['wr_7']) == false) { ?><p><img src="<?php echo $write['wr_7']; ?>"/></p><?php } ?>
        <?php if (empty($write['wr_8']) == false) { ?><p><img src="<?php echo $write['wr_8']; ?>"/></p><?php } ?>
...
<p><?php echo $board['bo_' . $i . '_subj']; ?>: <?php echo $write['wr_' . $i]; ?></p>
