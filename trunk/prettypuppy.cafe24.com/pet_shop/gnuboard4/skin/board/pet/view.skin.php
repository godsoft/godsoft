...
<?php
$pet_wr_id = sprintf('%010d', $wr_id);
?>

<a href="board.php?bo_table=sale&sca=&sfl=wr_2&stx=<?php echo $pet_wr_id; ?>&x=30&y=12&sop=and" target="sale_frame">판매 목록</a>
| <a href="write.php?bo_table=sale&wr_1=<?php echo $write['wr_1']; ?>&wr_2=<?php echo $pet_wr_id; ?>" target="sale_frame">판매 등록</a>

<?php
for ($i = 1; $i < 11; $i++) {
    //var_dump(isset($write['wr_' . $i])) ;
...
<p><?php echo $board['bo_' . $i . '_subj']; ?>: <?php echo $write2['wr_' . $i]; ?></p>
...
<?php
////var_dump($board['bo_1_subj']);
////var_dump($write['wr_1']);
//
//if ($board['bo_1_subj'] == '고객 아이디') {
//    //var_dump($g4['write_prefix'] . $bo_table);
//
//    $sql = "
//    select *
