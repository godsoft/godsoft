...
<div id="nav">	
	...
	<ul>
		...
		<li class="leftmenu_dept01">
			<a href="EgovAboutSite.jsp">사이트소개</a>
			<ul>
		...
		<li class="leftmenu_dept01">
			<a href="EgovProductInfo.jsp">정보마당</a>
			<ul>	
				<li class="dept02"><a href="javascript:fn_main_headPageMove('21','main/sample_menu/EgovProductInfo')">대표제품 소개</a></li>
		...
		<li class="leftmenu_dept01">
			<a href="EgovDownload.jsp">고객지원</a>
			<ul>
		...
		<li class="leftmenu_dept01">
			<a href="EgovSchedule.jsp">알림마당</a>
			<ul>
		...
		<li class="leftmenu_dept01">
			<a href="EgovSchedule.jsp">사이트관리</a>
			<ul>	
