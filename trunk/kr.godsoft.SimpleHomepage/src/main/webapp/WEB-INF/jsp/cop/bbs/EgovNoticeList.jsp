                            ...
                            <ul id="search_first_ul">
                                ...
                                <li>
                                    <div class="buttons" style="position:absolute;left:870px;top:182px;">
                                        <a href="#LINK" onclick="javascript:fn_egov_select_noticeList('1'); return false;"><img src="/sht/images/img_search.gif" alt="search" />조회 </a>
                ...
                <div class="default_tablestyle">
                    ...
                    <!-- loop 시작 -->                                
                      <tr>
				        ...
				        <td><b><c:out value="${(searchVO.pageIndex-1) * searchVO.pageSize + status.count}"/></b></td>            
				        <td align="left">
