...
<p><label for="wr_<?php echo $i; ?>"><?php echo $board['bo_' . $i . '_subj']; ?></label>: <input type="text" name="wr_<?php echo $i; ?>" id="wr_<?php echo $i; ?>" value="<?php echo $write['wr_' . $i]; ?>" style="width: 80%;" /></p>
