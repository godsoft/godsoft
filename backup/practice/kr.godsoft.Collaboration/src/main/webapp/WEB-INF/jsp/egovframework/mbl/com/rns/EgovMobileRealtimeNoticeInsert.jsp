	    ...
	    <div id="regist" data-role="page" data-theme="d">
			...
			<div data-role="content"  class="egov-mcomdContent">
				<dl class="realtimeView">
					...
					<dd>
						<input id="noticeBgnDt" name="defandroid" type="date" data-role="datebox" id="defandroid" readonly='true'/>
						<br>
				    	<input id="noticeEndDt" name="defandroid" type="date" data-role="datebox" id="defandroid" readonly='true'/>
			    	</dd>
				</dl>
