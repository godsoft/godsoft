<% 
/**
 * @Class Name : EgovBuildingLocationInfoUpdt.jsp
 * @Description : 건물 위치정보 수정
...
<script type="text/javascript">
	...
	function fn_egov_updt_geoLocation(){
		if(!validateGeoLocation(document.geoLocation)) {
			return;
		}
		
		if (confirm("<spring:message code="common.update.msg" />"))    {  
		    document.geoLocation.action = "<c:url value='/mbl/com/geo/updateBuildingLocationInfo.mdo'/>";
		    document.geoLocation.submit();
		}
	}
	
</script>
<title>건물 위치 정보 수정</title>
...
<noscript class="noScriptTitle">자바스크립트를 지원하지 않는 브라우저에서는 일부 기능을 사용하실 수 없습니다.</noscript>
	...
	<div id="content" class="contents2">
		...
		<table width="100%" cellpadding="8" class="table-search" border="0">
		 <tr>
		  <td width="100%"class="title_left">
		   <img src="<c:url value='/images/egovframework/mbl/mcomd/com/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">
		   &nbsp;건물 위치 정보 - 수정</td>
		 </tr>
		</table>
		<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="건물 위치 정보를 수정합니다.">
		<tbody>
		  <tr> 
		    ...
		    <td width="80%" nowrap>
		    	<input name="buldNm" type="text" style="width:50%;height:100%;" value='<c:out value="${geoLocation.buldNm}"/>'>
		    </td>
		  </tr>
		  <tr> 
		    <th width="20%" height="23" nowrap >전화번호&nbsp;</th>
		    <td width="80%" nowrap>
		    	<input name="telno" type="text" style="width:50%;height:100%;" value='<c:out value="${geoLocation.telno}"/>'>
		    </td>
		  </tr>
		  <tr> 
		    <th width="20%" height="23" nowrap >주소&nbsp;</th>
		    <td width="80%" nowrap>
		    	<input name="adres" type="text" style="width:50%;height:100%;" value='<c:out value="${geoLocation.adres}"/>'>
		    </td>
		  </tr>
		  <tr> 
		    ...
		    <td width="80%" nowrap>
		    	<input name="la" type="text" style="width:50%;height:100%;" value='<c:out value="${geoLocation.la}"/>'>
		    </td>
		  </tr>
		  <tr> 
		    ...
		    <td width="80%" nowrap>
		    	<input name="lo" type="text" style="width:50%;height:100%;" value='<c:out value="${geoLocation.lo}"/>'>
		    </td>
		  </tr>
		</tbody>
		</table>
		...
		<table border="0" cellspacing="0" cellpadding="0" align="center">
			<tr> 
				<td>
					<img src="<c:url value='/images/egovframework/mbl/mcomd/button/bu2_left.gif'/>" width="8" height="20" alt="수정버튼이미지">
				</td>
				<td background="<c:url value='/images/egovframework/mbl/mcomd/button/bu2_bg.gif'/>" class="text_left" nowrap>
					<a href="JavaScript:fn_egov_updt_geoLocation();">수정</a>
				</td>
				<td>
					<img src="<c:url value='/images/egovframework/mbl/mcomd/button/bu2_right.gif'/>" width="8" height="20" alt="수정버튼이미지">
				</td>
				<td>&nbsp;</td>  
				<td>
				...
				<td background="<c:url value='/images/egovframework/mbl/mcomd/button/bu2_bg.gif'/>" class="text_left" nowrap>
					...
					<input name="sn" type="hidden" value="<c:out value='${geoLocation.sn}'/>"> 
