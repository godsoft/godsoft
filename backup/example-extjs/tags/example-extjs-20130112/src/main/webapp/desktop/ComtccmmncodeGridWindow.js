...
Ext
        .define(
                'MyDesktop.ComtccmmncodeGridWindow',
                {
                    ...
                    id : 'grid-win-comtccmmncode',

                    init : function() {
                        this.launcher = {
                            text : 'Comtccmmncode Grid Window',
                            iconCls : 'icon-grid'
                        };
                    },
                    ...
                    createWindow : function() {
                        ...
                        var win = desktop.getWindow('grid-win-comtccmmncode');
                        if (!win) {
                            ...
                            var myStore = Ext
                                    .create(
                                            'Ext.data.Store',
                                            {
                                                ...
                                                proxy : {
                                                    type : 'ajax',
                                                    url : '/example-extjs/comtccmmncode/selectComtccmmncodeListJson.do',
                                                    reader : {
                                                        type : 'json',
                                                        root : 'resultList'
                                                    }
                            ...
                            win = desktop.createWindow({
                                id : 'grid-win-comtccmmncode',
                                title : 'Comtccmmncode Grid Window',
                                width : 740,
                                height : 480,
                                iconCls : 'icon-grid',
                                animCollapse : false,
