package egovframework.codegen.comtccmmndetailcode.web;
...
import egovframework.codegen.comtccmmndetailcode.service.ComtccmmndetailcodeService;
...
public class ComtccmmndetailcodeController {
     ...
     * @return "egovframework/codegen/comtccmmndetailcode/ComtccmmndetailcodeList"
     * @exception Exception
     */
    @RequestMapping(value="/comtccmmndetailcode/selectComtccmmndetailcodeList.do")
    ...
    @RequestMapping(value="/comtccmmndetailcode/selectComtccmmndetailcodeListJson.do")
    public ModelAndView selectComtccmmndetailcodeListJson(@ModelAttribute("searchVO") ComtccmmndetailcodeDefaultVO searchVO,
            ModelMap model)
            throws Exception {
    ...
    public String addComtccmmndetailcodeView(
        ...
        return "egovframework/codegen/comtccmmndetailcode/ComtccmmndetailcodeRegist";
    }
    ...
    public String addComtccmmndetailcode(
        ...
        status.setComplete();
        return "redirect:/comtccmmndetailcode/selectComtccmmndetailcodeList.do";
    }
