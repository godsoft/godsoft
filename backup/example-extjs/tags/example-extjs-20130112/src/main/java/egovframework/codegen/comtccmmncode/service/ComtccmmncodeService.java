...
public interface ComtccmmncodeService {
     ...
     * @exception Exception
     */
    int updateComtccmmncode(ComtccmmncodeVO vo) throws Exception;
     ...
     * @exception Exception
     */
    int deleteComtccmmncode(ComtccmmncodeVO vo) throws Exception;
     ...
     * @exception Exception
     */
    List<EgovMap> selectComtccmmncodeList(ComtccmmncodeDefaultVO searchVO) throws Exception;
