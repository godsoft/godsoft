...
Ext
        .define(
                'MyDesktop.ComtsusersummaryGridWindow',
                {
                    ...
                    id : 'grid-win-comtsusersummary',

                    init : function() {
                        this.launcher = {
                            text : 'Comtsusersummary Grid Window',
                            iconCls : 'icon-grid'
                        };
                    },
                    ...
                    createWindow : function() {
                        ...
                        var win = desktop.getWindow('grid-win-comtsusersummary');
                        if (!win) {
                            ...
                            var myStore = Ext
                                    .create(
                                            'Ext.data.Store',
                                            {
                                                ...
                                                proxy : {
                                                    type : 'ajax',
                                                    url : '/example-extjs/comtsusersummary/selectComtsusersummaryListJson.do',
                                                    reader : {
                                                        type : 'json',
                                                        root : 'resultList'
                                                    }
                            ...
                            win = desktop.createWindow({
                                id : 'grid-win-comtsusersummary',
                                title : 'Comtsusersummary Grid Window',
                                width : 740,
                                height : 480,
                                iconCls : 'icon-grid',
                                animCollapse : false,
