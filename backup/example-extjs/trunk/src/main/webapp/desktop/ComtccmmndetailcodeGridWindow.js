...
Ext
        .define(
                'MyDesktop.ComtccmmndetailcodeGridWindow',
                {
                    ...
                    id : 'grid-win-comtccmmndetailcode',

                    init : function() {
                        this.launcher = {
                            text : 'Comtccmmndetailcode Grid Window',
                            iconCls : 'icon-grid'
                        };
                    },
                    ...
                    createWindow : function() {
                        ...
                        var win = desktop.getWindow('grid-win-comtccmmndetailcode');
                        if (!win) {
                            ...
                            var myStore = Ext
                                    .create(
                                            'Ext.data.Store',
                                            {
                                                ...
                                                proxy : {
                                                    type : 'ajax',
                                                    url : '/example-extjs/comtccmmndetailcode/selectComtccmmndetailcodeListJson.do',
                                                    reader : {
                                                        type : 'json',
                                                        root : 'resultList'
                                                    }
                            ...
                            win = desktop.createWindow({
                                id : 'grid-win-comtccmmndetailcode',
                                title : 'Comtccmmndetailcode Grid Window',
                                width : 740,
                                height : 480,
                                iconCls : 'icon-grid',
                                animCollapse : false,
