...
Ext
        .define(
                'MyDesktop.ComtsweblogsummaryGridWindow',
                {
                    ...
                    id : 'grid-win-comtsweblogsummary',

                    init : function() {
                        this.launcher = {
                            text : 'Comtsweblogsummary Grid Window',
                            iconCls : 'icon-grid'
                        };
                    },
                    ...
                    createWindow : function() {
                        ...
                        var win = desktop.getWindow('grid-win-comtsweblogsummary');
                        if (!win) {
                            ...
                            var myStore = Ext
                                    .create(
                                            'Ext.data.Store',
                                            {
                                                ...
                                                proxy : {
                                                    type : 'ajax',
                                                    url : '/example-extjs/comtsweblogsummary/selectComtsweblogsummaryListJson.do',
                                                    reader : {
                                                        type : 'json',
                                                        root : 'resultList'
                                                    }
                            ...
                            win = desktop.createWindow({
                                id : 'grid-win-comtsweblogsummary',
                                title : 'Comtsweblogsummary Grid Window',
                                width : 740,
                                height : 480,
                                iconCls : 'icon-grid',
                                animCollapse : false,
