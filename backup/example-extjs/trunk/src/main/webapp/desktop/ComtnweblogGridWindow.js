...
Ext
        .define(
                'MyDesktop.ComtnweblogGridWindow',
                {
                    ...
                    id : 'grid-win-comtnweblog',

                    init : function() {
                        this.launcher = {
                            text : 'Comtnweblog Grid Window',
                            iconCls : 'icon-grid'
                        };
                    },
                    ...
                    createWindow : function() {
                        ...
                        var win = desktop.getWindow('grid-win-comtnweblog');
                        if (!win) {
                            ...
                            var myStore = Ext
                                    .create(
                                            'Ext.data.Store',
                                            {
                                                ...
                                                proxy : {
                                                    type : 'ajax',
                                                    url : '/example-extjs/comtnweblog/selectComtnweblogListJson.do',
                                                    reader : {
                                                        type : 'json',
                                                        root : 'resultList'
                                                    }
