...
<%
 /**
  * @Class Name : ComtsweblogsummaryRegister.jsp
  * @Description : Comtsweblogsummary Register 화면
...
<!-- validator:javascript formName="comtsweblogsummaryVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
    document.getElementById("detailForm").action = "<c:url value='/comtsweblogsummary/selectComtsweblogsummaryList.do'/>";
...
function fn_egov_delete() {
    document.getElementById("detailForm").action = "<c:url value='/comtsweblogsummary/deleteComtsweblogsummary.do'/>";
    document.getElementById("detailForm").submit();
}
...
function fn_egov_save() {
    ...
    form.action = "<c:url value="${registerFlag == '등록' ? '/comtsweblogsummary/addComtsweblogsummary.do' : '/comtsweblogsummary/updateComtsweblogsummary.do'}"/>";
    form.submit();
}
//-->
</script>
