...
<!-- validator:javascript formName="comtccmmndetailcodeVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
    document.getElementById("detailForm").action = "<c:url value='/comtccmmndetailcode/selectComtccmmndetailcodeList.do'/>";
...
function fn_egov_delete() {
    document.getElementById("detailForm").action = "<c:url value='/comtccmmndetailcode/deleteComtccmmndetailcode.do'/>";
    document.getElementById("detailForm").submit();
}
...
function fn_egov_save() {
    ...
    form.action = "<c:url value="${registerFlag == '등록' ? '/comtccmmndetailcode/addComtccmmndetailcode.do' : '/comtccmmndetailcode/updateComtccmmndetailcode.do'}"/>";
    form.submit();
}
//-->
</script>
...
<div id="content_pop">
    ...
    <table width="100%" border="1" cellpadding="0" cellspacing="0" >
        ...
        <tr>
            ...
            <td>${comtccmmndetailcodeVO.frstRegistPnttm}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>${comtccmmndetailcodeVO.lastUpdtPnttm}</td>
        </tr>
        <tr>
