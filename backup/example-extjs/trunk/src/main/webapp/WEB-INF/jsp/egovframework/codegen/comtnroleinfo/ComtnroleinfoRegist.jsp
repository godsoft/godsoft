...
function fn_egov_selectList() {
    document.getElementById("detailForm").action = "<c:url value='/comtnroleinfo/selectComtnroleinfoList.do'/>";
...
function fn_egov_save() {
    ...
    form.action = "<c:url value="${registerFlag == '등록' ? '/comtnroleinfo/addComtnroleinfo.do' : '/comtnroleinfo/updateComtnroleinfo.do'}"/>";
    form.submit();
}
//-->
</script>
