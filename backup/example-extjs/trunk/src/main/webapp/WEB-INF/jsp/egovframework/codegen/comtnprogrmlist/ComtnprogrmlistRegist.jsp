...
<%
 /**
  * @Class Name : ComtnprogrmlistRegister.jsp
  * @Description : Comtnprogrmlist Register 화면
...
<!-- validator:javascript formName="comtnprogrmlistVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
    document.getElementById("detailForm").action = "<c:url value='/comtnprogrmlist/selectComtnprogrmlistList.do'/>";
...
function fn_egov_delete() {
    document.getElementById("detailForm").action = "<c:url value='/comtnprogrmlist/deleteComtnprogrmlist.do'/>";
    document.getElementById("detailForm").submit();
}
...
function fn_egov_save() {
    ...
    form.action = "<c:url value="${registerFlag == '등록' ? '/comtnprogrmlist/addComtnprogrmlist.do' : '/comtnprogrmlist/updateComtnprogrmlist.do'}"/>";
    form.submit();
}
//-->
</script>
