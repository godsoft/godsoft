...
<%
 /**
  * @Class Name : selectComtsusersummaryList.jsp
...
function fn_egov_link_page(pageNo){
    ...
    document.getElementById("listForm").action = "<c:url value='/comtsusersummary/selectComtsusersummaryList.do'/>";
    document.getElementById("listForm").submit();
}
