...
<%
 /**
  * @Class Name : selectComtssyslogsummaryList.jsp
  * @Description : Comtssyslogsummary List 화면
...
<!--
/* 글 수정 화면 function */
function fn_egov_select(occrrncDe, svcNm, methodNm) {
    ...
    document.getElementById("listForm").action = "<c:url value='/comtssyslogsummary/updateComtssyslogsummaryView.do'/>";
    document.getElementById("listForm").submit();
}

/* 글 등록 화면 function */
function fn_egov_addView() {
    document.getElementById("listForm").action = "<c:url value='/comtssyslogsummary/addComtssyslogsummaryView.do'/>";
    document.getElementById("listForm").submit();
}
...
function fn_egov_link_page(pageNo){
    ...
    document.getElementById("listForm").action = "<c:url value='/comtssyslogsummary/selectComtssyslogsummaryList.do'/>";
    document.getElementById("listForm").submit();
}
