...
<%
 /**
  * @Class Name : selectIdsList.jsp
  * @Description : Ids List 화면
...
function fn_egov_addView() {
    document.getElementById("listForm").action = "<c:url value='/ids/addIdsView.do'/>";
    document.getElementById("listForm").submit();
}
...
function fn_egov_link_page(pageNo){
    ...
    document.getElementById("listForm").action = "<c:url value='/ids/selectIdsList.do'/>";
    document.getElementById("listForm").submit();
}
