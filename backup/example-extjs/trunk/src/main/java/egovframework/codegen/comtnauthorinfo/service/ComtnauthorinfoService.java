...
public interface ComtnauthorinfoService {
     ...
     * @exception Exception
     */
    int updateComtnauthorinfo(ComtnauthorinfoVO vo) throws Exception;
     ...
     * @exception Exception
     */
    int deleteComtnauthorinfo(ComtnauthorinfoVO vo) throws Exception;
     ...
     * @exception Exception
     */
    List<EgovMap> selectComtnauthorinfoList(ComtnauthorinfoDefaultVO searchVO) throws Exception;
