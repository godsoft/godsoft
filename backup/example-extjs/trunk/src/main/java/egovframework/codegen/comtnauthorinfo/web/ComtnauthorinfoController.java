package egovframework.codegen.comtnauthorinfo.web;
...
import egovframework.codegen.comtnauthorinfo.service.ComtnauthorinfoService;
...
public class ComtnauthorinfoController {
     ...
     * @return "egovframework/codegen/comtnauthorinfo/ComtnauthorinfoList"
     * @exception Exception
     */
    @RequestMapping(value="/comtnauthorinfo/selectComtnauthorinfoList.do")
    ...
    @RequestMapping(value="/comtnauthorinfo/selectComtnauthorinfoListJson.do")
    public ModelAndView selectComtnauthorinfoListJson(@ModelAttribute("searchVO") ComtnauthorinfoDefaultVO searchVO,
            ModelMap model)
            throws Exception {
    ...
    public String addComtnauthorinfoView(
        ...
        return "egovframework/codegen/comtnauthorinfo/ComtnauthorinfoRegist";
    }
    ...
    public String addComtnauthorinfo(
        ...
        status.setComplete();
        return "redirect:/comtnauthorinfo/selectComtnauthorinfoList.do";
    }
