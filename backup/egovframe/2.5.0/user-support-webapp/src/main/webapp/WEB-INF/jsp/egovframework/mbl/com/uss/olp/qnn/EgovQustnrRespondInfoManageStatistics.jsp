					...
					<ul class="uss-hpcDetail">
						...
						<li>
							...
							<span class="uss-con gray">
								<label for="name-d"><strong><c:out value="${comtnqestnrinfo.qestnrSj}" /></strong></label>
							</span>
						</li>
						...
						<li>
							...
							<span class="uss-con gray">
								<label for="name-d"><strong><c:out value="${comtnqestnrinfo.qestnrPurps}" /></strong></label>
							</span>
						</li>
						...
						<li>
							...
							<span class="uss-con gray">
								<label for="name-d"><strong><c:out value="${comtnqestnrinfo.qestnrWritngGuidanceCn}" /></strong></label>
							</span>
						</li>
											...
											<dd>	
												<c:forEach items="${qestnrStatistic1}" var="qestmStatistic1" varStatus="status3">
							    					<c:if test="${qestmInfo.qestnrTmplatId eq qestmStatistic1.qestnrTmplatId && qestmInfo.qestnrId eq qestmStatistic1.qestnrId && qestmStatistic1.qestnrQesitmId eq qestmItem.qestnrQesitmId && qestmStatistic1.qustnrIemId eq qestmItem.qustnrIemId}">
							    						<img src="${pageContext.request.contextPath}/images/egovframework/com/uss/olp/qnn/chart/chart${chartCount}.JPG" width="${qestmStatistic1.qustnrPercent}px" height="8"> ${qestmStatistic1.qustnrPercent}%							    					
							    						<c:set var="chartCheck" value="${chartCheck+1}" />
							    					</c:if>
							    				</c:forEach>

							    				<c:if test="${chartCheck eq 0}">
							    					<img src="${pageContext.request.contextPath}/images/egovframework/com/uss/olp/qnn/chart/chart${chartCount}.JPG" width="0 px" height="8"> 0%
							    				</c:if>
							    			</dd>
