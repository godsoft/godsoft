	...
	<head>
		...
		<!--
			...
			function initList() {
	   			...
	   			$.getJSON("${pageContext.request.contextPath}/cop/smt/sdm/EgovDeptSchdulManageWeekListActor.mdo", $('#searchVO').serialize(), function(json){
	...
	<div id="list" data-role="page">
		...
		<div data-role="header">
			...
			<div data-role="navbar">
				<ul>
					<li><a href="${pageContext.request.contextPath}/cop/smt/sdm/EgovDeptSchdulManageWeekList.mdo" class="ui-btn-active" id="week" name="week" data-ajax="false">주간별 일정보기</a></li>
					<li><a href="${pageContext.request.contextPath}/cop/smt/sdm/EgovDeptSchdulManageDailyList.mdo" id="date" name="date" data-ajax="false">일별 일정보기</a></li>
				</ul>
			</div>
		</div>			
		<!-- header end -->
