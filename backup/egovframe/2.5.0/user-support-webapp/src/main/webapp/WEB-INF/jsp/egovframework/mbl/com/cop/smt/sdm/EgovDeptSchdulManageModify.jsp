...
<html>
	...
	<head>
		...
		<!-- datebox javascript-->
		<link rel="stylesheet" href="${pageContext.request.contextPath}/css/egovframework/mbl/cmm/datepicker/jqm-datebox.css" />

		<script type="text/javascript" src="${pageContext.request.contextPath}/js/egovframework/mbl/cmm/datepicker/jqm-datebox.core.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/egovframework/mbl/cmm/datepicker/jqm-datebox.mode.calbox.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/egovframework/mbl/cmm/datepicker/jqm-datebox.mode.datebox.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/egovframework/mbl/cmm/datepicker/jqm-datebox.mode.flipbox.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/egovframework/mbl/cmm/datepicker/jquery.mobile.datebox.i18n.ko.utf8.js"></script>
		...
		<!-- 
			...
			function fn_egov_updt() {
				...
				if(!validateDeptSchdulManageVO(document.detailForm)) {
					return;
				}
									
				var url = "${pageContext.request.contextPath}/cop/smt/sdm/EgovDeptSchdulManageModifyActor.mdo";
		...
		<div id="view" data-role="page">
			...
			<!-- searchVO start -->				
				<form id="searchVO" name="searchVO" method="post">
					...
					<input type="hidden" id="schdulId" name="schdulId" value="${deptSchdulManageVO.schdulId}" />
				</form>
			<!-- searchVO end -->
			
			<form:form commandName="deptSchdulManageVO" id="detailForm" name="detailForm" method="post">
				...
				<div data-inline="true">
					<dl class="uss-registOk">
						...
						<dd class="department">
							...
							<div class="uss-typ4">
								<a href="${pageContext.request.contextPath}/uss/olp/mgt/EgovMeetingManageLisAuthorGroupPopupView.mdo" data-rel="dialog" id="layer_1" data-role="button" data-icon="search" data-iconpos="notext">조회</a>
							</div>
						</dd>
						...
						<dd class="department">
							<div>
								<span class="uss-dataBox"><form:input path="schdulBgndeYYYMMDD" type="date" data-role="datebox" data-options='{"mode": "datebox"}' /></span>
				        		<span class="uss-dataBox"><form:input path="schdulBgndeHH" type="date" data-role="datebox" data-options='{"mode": "timebox", "overrideTimeFormat": 24}' /></span>
							</div>
							<div class="uss-time">
			        			<span class="uss-dataBox"><form:input path="schdulEnddeYYYMMDD" type="date" data-role="datebox" data-options='{"mode": "datebox"}' /></span>
				        		<span class="uss-dataBox"><form:input path="schdulEnddeHH" type="date" data-role="datebox" data-options='{"mode": "timebox", "overrideTimeFormat": 24}' /></span>
			        		</div>
						</dd>
						...
						<dd>
							...
							<div class="uss-typ4">
								<a href="${pageContext.request.contextPath}/uss/olp/mgt/EgovMeetingManageLisEmpLyrPopupView.mdo" data-rel="dialog" id="layer_2" data-role="button" data-icon="search" data-iconpos="notext">조회</a>
							</div>
						</dd>
					</dl>
