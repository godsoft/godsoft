...
public class EgovMblOnlineManualController {
    ...
    public String mainBoard(@ModelAttribute("searchVO") ComDefaultVO searchVO, Map commandMap,
    ...
    public ModelAndView EgovOnlineManualUserList(
       ...
       // model.addAttribute("searchKeyword", commandMap.get("searchKeyword") == null ? "" : (String) commandMap.get("searchKeyword"));
        ...
        int totCnt = (Integer) egovOnlineManualService.selectOnlineManualListCnt(searchVO);
    ...
    public String EgovOnlineManualUserDetail(
            ...
            OnlineManual onlineManual, Map commandMap,
        ...
        OnlineManual reusltList = (OnlineManual)egovOnlineManualService.selectOnlineManualDetail(onlineManual);
