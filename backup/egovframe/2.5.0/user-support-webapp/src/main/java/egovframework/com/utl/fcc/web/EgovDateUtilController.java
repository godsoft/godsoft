        ...
        if(cmdStr==null||cmdStr.equals("")){
        	cmdStr="";
				...
				if(cmdStr.equals("ComUtlFccSlrcldLrrCnvr1")){ // test 샘플용 경로
					jspStr = "egovframework/com/utl/fcc/EgovSlrcldLrrCnvr";
					try {
					...
					jspStr = "egovframework/com/utl/fcc/EgovDateValidCeck";
					try {
						cmdModel.put("resultStr", "UTILITY 직접 호출");
					} catch (Exception e) {
						// TODO Auto-generated catch block
					...
					jspStr = "egovframework/com/utl/fcc/EgovDeRndmCreate";
					try {
						cmdModel.put("resultStr", "UTILITY 직접 호출");
					} catch (Exception e) {
						// TODO Auto-generated catch block
					...
					jspStr = "egovframework/com/utl/fcc/EgovDateCnvr";
					try {
						cmdModel.put("resultStr", "UTILITY 직접 호출");
					} catch (Exception e) {
						// TODO Auto-generated catch block
					...
					jspStr = "egovframework/com/utl/fcc/EgovDfkCnvr";
					try {
						cmdModel.put("resultStr", "UTILITY 직접 호출");
					} catch (Exception e) {
						// TODO Auto-generated catch block
						jspStr = "/egovDevIndex.jsp";
						//e.printStackTrace();
						logger.error(e);	// 2011.10.10 보안점검 후속조치
					}
					...
					jspStr = "egovframework/com/utl/fcc/EgovWeekCalc";
					try {
						cmdModel.put("resultStr", "UTILITY 직접 호출");
					} catch (Exception e) {
						// TODO Auto-generated catch block
