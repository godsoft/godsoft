...
public class EgovMblAdministrationWordManageController {
	    ...
	    public ModelAndView egovAdministrationWordManageList(
	        ...
	        int totCnt = (Integer) egovAdministrationWordManageService.selectAdministrationWordManageListCnt(searchVO);
	    ...
	    public String egovAdministrationWordDetail(
	        ...
	        AdministrationWordManage administrationWordManageVO = (AdministrationWordManage)egovAdministrationWordManageService.selectAdministrationWordManageDetail(administrationWordManage);
	    ...
	    public String egovAdministrationWordManageMainList(Map commandMap,
	            @ModelAttribute("searchVO") AdministrationWordManage searchVO, 
	            ModelMap model)
	            throws Exception {
