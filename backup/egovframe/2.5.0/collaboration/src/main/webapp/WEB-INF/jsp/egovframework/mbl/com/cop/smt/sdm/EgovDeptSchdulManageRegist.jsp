       ...
       <link rel="stylesheet" href="${pageContext.request.contextPath}/css/egovframework/mbl/cmm/jquery.mobile-1.1.1.min.css" />
		...
		<!--
			...
			function fn_save() {
				...
				var url = "${pageContext.request.contextPath}/cop/smt/sdm/EgovDeptSchdulManageRegistActor.mdo";
		...
		<div id="view" data-role="page">
			...
			<div data-role="content" class="com-ussContent">
				...
				<div data-inline="true">
					<dl class="uss-registOk">
						...
						<dd>
							...
							<div class="uss-typ4">
								<a href="${pageContext.request.contextPath}/uss/olp/mgt/EgovMeetingManageLisEmpLyrPopupView.mdo" id="layer_2" data-rel="dialog" data-role="button" data-icon="search" data-iconpos="notext">조회</a>
							</div>
						</dd>
					</dl>
				</div>
				...
				<div class="ui-grid-a uss-clear">
					<div class="ui-block-a"><a href="javascript:fn_save();" data-role="button" data-theme="b" data-ajax="false">저장</a></div>
