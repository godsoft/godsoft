...
<html>
	...
	<head>
		...
		<!--
			...
			function fn_save() {
				...
				var url = "${pageContext.request.contextPath}/cop/smt/sim/EgovIndvdlSchdulManageRegistActor.mdo";
	...
	<body>
		...
		<div id="view" data-role="page">
			...
			<form:form commandName="indvdlSchdulManageVO" id="detailForm" name="detailForm" method="post">
