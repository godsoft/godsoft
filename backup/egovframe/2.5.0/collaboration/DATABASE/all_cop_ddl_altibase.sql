...
CREATE TABLE COMTNDEVICE
  (
    SN					NUMBER(20,0) NOT NULL ,
    MBER_ID				VARCHAR2(20) NOT NULL ,
    UAGENT_INFO			VARCHAR2(1024),
    BROWSER_CODE_ID		VARCHAR2(6),
    BROWSER_CODE		VARCHAR2(15),
    OS_CODE_ID			VARCHAR2(6),
    OS_CODE				VARCHAR2(15),
    RECENT_CODE_ID		VARCHAR2(6),
    RECENT_CODE			VARCHAR2(15),
    CREAT_DT			DATE NOT NULL ,
...
CREATE TABLE COMTNOFFLINEWEB
  (
    SN			NUMBER(20,0) NOT NULL ,
    MBER_ID		VARCHAR2(20) NOT NULL ,
    OFFLINE_SJ	VARCHAR2(256),
    OFFLINE_CN	VARCHAR2(2048),
    CREAT_DT	DATE NOT NULL ,
    UPDT_DT		DATE NOT NULL ,
...
CREATE TABLE COMTNREALTIMENOTICE
 (
	SN					NUMBER(20,0) NOT NULL ,
    MBER_ID				VARCHAR2(20) NOT NULL ,
    NOTICE_SJ			VARCHAR2(256),
    NOTICE_CN			VARCHAR2(2048),
    RECENT_CODE_ID		VARCHAR2(6),
    RECENT_CODE			VARCHAR2(15),
...
CREATE TABLE COMTNSYNC
  (
    SN			NUMBER(20,0) NOT NULL ,
    MBER_ID		VARCHAR2(20) NOT NULL ,
    SYNC_SJ		VARCHAR2(256),
    SYNC_CN		VARCHAR2(2048),
    SYNC_DT		DATE,
    CREAT_DT	DATE NOT NULL ,
    UPDT_DT		DATE NOT NULL ,
