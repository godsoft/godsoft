...
public class EgovRssController {
    ...
    public String EgovRssTagServiceList(
        ...
        int totCnt = (Integer) egovRssService.selectRssTagServiceListCnt(searchVO);
    ...
    public String EgovRssTagServiceDetail(
    		...
    		if(!sRssId.equals("")){
    			...
    			model.addAttribute("mapRssInfo",(Map)mapRssInfo);
    			
    			model.addAttribute("mapRssInfoList", (List)egovRssService.selectRssTagServiceTable(mapRssInfo));
