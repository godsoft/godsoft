...
<%
 /**
  * @Class Name : MdIndexDetailsList.jsp
  * @Description : MdIndexDetails List 화면
...
<title>This table stores the details of an index.  It shows what columns are "part" of the index. 목록</title>
...
function fn_egov_select(id) {
	document.getElementById("listForm").id.value = id;
   	document.getElementById("listForm").action = "<c:url value='/mdIndexDetails/updateMdIndexDetailsView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/mdIndexDetails/addMdIndexDetailsView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/mdIndexDetails/MdIndexDetailsList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								...
								<th align="center">The index to which this detail belongs. //PARENTFIELD</th>
								<th align="center">column_id_fk</th>
								<th align="center">To support indexing on part of a field</th>
			...
			<tr>
												...
												<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.id}"/>')"><c:out value="${result.id}"/></a>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.indexIdFk}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.columnIdFk}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.indexPortion}"/>&nbsp;</td>
