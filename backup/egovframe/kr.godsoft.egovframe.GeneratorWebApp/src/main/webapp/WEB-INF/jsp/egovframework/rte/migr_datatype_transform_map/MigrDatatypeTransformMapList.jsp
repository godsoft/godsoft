...
<%
 /**
  * @Class Name : MigrDatatypeTransformMapList.jsp
  * @Description : MigrDatatypeTransformMap List 화면
...
<title>Table for storing data type maps.  A map is simply a collection of rules 목록</title>
...
function fn_egov_select(id) {
	document.getElementById("listForm").id.value = id;
   	document.getElementById("listForm").action = "<c:url value='/migrDatatypeTransformMap/updateMigrDatatypeTransformMapView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/migrDatatypeTransformMap/addMigrDatatypeTransformMapView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/migrDatatypeTransformMap/MigrDatatypeTransformMapList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								...
								<th align="center">A name for the map</th>
			...
			<tr>
												...
												<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.id}"/>')"><c:out value="${result.id}"/></a>&nbsp;</td>
																...
																<td align="center" class="listtd"><c:out value="${result.mapName}"/>&nbsp;</td>
