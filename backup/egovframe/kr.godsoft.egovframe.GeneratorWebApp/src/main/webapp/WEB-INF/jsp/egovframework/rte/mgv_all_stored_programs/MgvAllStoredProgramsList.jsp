...
<%
 /**
  * @Class Name : MgvAllStoredProgramsList.jsp
  * @Description : MgvAllStoredPrograms List 화면
...
<title>mgv_all_stored_programs 목록</title>
<link type="text/css" rel="stylesheet" href="<c:url value='/css/egovframework/sample.css'/>"/>
<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 수정 화면 function */
function fn_egov_select() {
   	document.getElementById("listForm").action = "<c:url value='/mgvAllStoredPrograms/updateMgvAllStoredProgramsView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/mgvAllStoredPrograms/addMgvAllStoredProgramsView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/mgvAllStoredPrograms/MgvAllStoredProgramsList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								...
								<th align="center">stored_program_id</th>
								<th align="center">programtype</th>
								<th align="center">stored_program_name</th>
								<th align="center">package_id_fk</th>
							</tr>
			...
			<tr>
												...
												<td align="center" class="listtd"><c:out value="${result.projectId}"/>&nbsp;</td>
																...
																<td align="center" class="listtd"><c:out value="${result.storedProgramId}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.programtype}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.storedProgramName}"/>&nbsp;</td>
