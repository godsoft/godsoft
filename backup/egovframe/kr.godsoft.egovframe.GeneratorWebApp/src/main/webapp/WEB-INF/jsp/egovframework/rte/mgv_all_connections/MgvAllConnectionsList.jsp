...
<%
 /**
  * @Class Name : MgvAllConnectionsList.jsp
  * @Description : MgvAllConnections List 화면
...
<title>mgv_all_connections 목록</title>
<link type="text/css" rel="stylesheet" href="<c:url value='/css/egovframework/sample.css'/>"/>
<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 수정 화면 function */
function fn_egov_select() {
   	document.getElementById("listForm").action = "<c:url value='/mgvAllConnections/updateMgvAllConnectionsView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/mgvAllConnections/addMgvAllConnectionsView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/mgvAllConnections/MgvAllConnectionsList.do'/>";
   	document.getElementById("listForm").submit();
}
