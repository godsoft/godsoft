...
<c:set var="registerFlag" value="${empty comtnclubuserVO.cmmntyId ? '등록' : '수정'}"/>
<c:set var="registerFlag" value="${empty comtnclubuserVO.emplyrId ? '등록' : '수정'}"/>
<title>comtnclubuser <c:out value="${registerFlag}"/> </title>
