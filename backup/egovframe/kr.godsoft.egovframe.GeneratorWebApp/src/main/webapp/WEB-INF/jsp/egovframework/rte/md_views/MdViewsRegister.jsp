...
<%
 /**
  * @Class Name : MdViewsRegister.jsp
  * @Description : MdViews Register 화면
...
<c:set var="registerFlag" value="${empty mdViewsVO.id ? '등록' : '수정'}"/>
<title>For storing information on views. <c:out value="${registerFlag}"/> </title>
<link type="text/css" rel="stylesheet" href="<c:url value='/css/egovframework/sample.css'/>"/>

<!--For Commons Validator Client Side-->
<!-- script type="text/javascript" src="<c:url value='/cmmn/validator.do'/>"></script -->
<!-- validator:javascript formName="mdViewsVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/mdViews/MdViewsList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/mdViews/deleteMdViews.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/mdViews/addMdViews.do' : '/mdViews/updateMdViews.do'}"/>";
    frm.submit();
...
<form:form commandName="mdViewsVO" name="detailForm" id="detailForm">
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" >
		...
		<tr>
			<th>The schema to which this obect blongs. //PARENTFIELD</th>
			<td>
		...
		<tr>
			<th>The name of the view //OBJECTNAME</th>
			<td>
