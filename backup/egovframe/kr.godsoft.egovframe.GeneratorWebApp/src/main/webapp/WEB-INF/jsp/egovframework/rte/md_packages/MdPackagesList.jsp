...
<%
 /**
  * @Class Name : MdPackagesList.jsp
  * @Description : MdPackages List 화면
...
<title>For storing packages 목록</title>
...
function fn_egov_select(id) {
	document.getElementById("listForm").id.value = id;
   	document.getElementById("listForm").action = "<c:url value='/mdPackages/updateMdPackagesView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/mdPackages/addMdPackagesView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/mdPackages/MdPackagesList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								...
								<th align="center">the schema in which this package resides //PARENTFIELD</th>
								<th align="center">Name of this package //OBJECTNAME</th>
								<th align="center">package_header</th>
								<th align="center">The SQL used to create this package at source</th>
								<th align="center">A unique identifer for this object at source.</th>
			...
			<tr>
												...
												<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.id}"/>')"><c:out value="${result.id}"/></a>&nbsp;</td>
																...
																<td align="center" class="listtd"><c:out value="${result.packageHeader}"/>&nbsp;</td>
