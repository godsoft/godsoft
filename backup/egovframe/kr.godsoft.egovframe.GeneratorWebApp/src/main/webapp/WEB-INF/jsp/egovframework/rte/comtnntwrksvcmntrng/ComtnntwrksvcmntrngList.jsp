...
<%
 /**
  * @Class Name : ComtnntwrksvcmntrngList.jsp
  * @Description : Comtnntwrksvcmntrng List 화면
...
<title>comtnntwrksvcmntrng 목록</title>
<link type="text/css" rel="stylesheet" href="<c:url value='/css/egovframework/sample.css'/>"/>
<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 수정 화면 function */
function fn_egov_select(sysIp, sysPort) {
	document.getElementById("listForm").sysIp.value = sysIp;
	document.getElementById("listForm").sysPort.value = sysPort;
   	document.getElementById("listForm").action = "<c:url value='/comtnntwrksvcmntrng/updateComtnntwrksvcmntrngView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/comtnntwrksvcmntrng/addComtnntwrksvcmntrngView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/comtnntwrksvcmntrng/ComtnntwrksvcmntrngList.do'/>";
   	document.getElementById("listForm").submit();
}
