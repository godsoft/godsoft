...
<%
 /**
  * @Class Name : MdUsersRegister.jsp
  * @Description : MdUsers Register 화면
...
<c:set var="registerFlag" value="${empty mdUsersVO.id ? '등록' : '수정'}"/>
<title>User information. <c:out value="${registerFlag}"/> </title>
<link type="text/css" rel="stylesheet" href="<c:url value='/css/egovframework/sample.css'/>"/>

<!--For Commons Validator Client Side-->
<!-- script type="text/javascript" src="<c:url value='/cmmn/validator.do'/>"></script -->
<!-- validator:javascript formName="mdUsersVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/mdUsers/MdUsersList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/mdUsers/deleteMdUsers.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/mdUsers/addMdUsers.do' : '/mdUsers/updateMdUsers.do'}"/>";
    frm.submit();
...
<form:form commandName="mdUsersVO" name="detailForm" id="detailForm">
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" >
		...
		<tr>
			<th>Shema in which this object belongs //PARENTFIELD</th>
			<td>
		...
		<tr>
			<th>Username for login //OBJECTNAME</th>
			<td>
