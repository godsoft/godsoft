...
<%
 /**
  * @Class Name : MdOtherObjectsList.jsp
  * @Description : MdOtherObjects List 화면
...
<title>For storing objects that don't belong anywhere else 목록</title>
...
function fn_egov_select(id) {
	document.getElementById("listForm").id.value = id;
   	document.getElementById("listForm").action = "<c:url value='/mdOtherObjects/updateMdOtherObjectsView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/mdOtherObjects/addMdOtherObjectsView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/mdOtherObjects/MdOtherObjectsList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								...
								<th align="center">Name of this object //OBJECTNAME</th>
								<th align="center">The native SQL used to create this object</th>
								<th align="center">A key that identifies this object at source.</th>
