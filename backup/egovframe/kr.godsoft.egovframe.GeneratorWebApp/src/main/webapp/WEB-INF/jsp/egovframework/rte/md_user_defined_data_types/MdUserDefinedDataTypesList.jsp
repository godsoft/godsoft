...
<%
 /**
  * @Class Name : MdUserDefinedDataTypesList.jsp
  * @Description : MdUserDefinedDataTypes List 화면
...
<title>For sotring information on user defined data types. 목록</title>
...
function fn_egov_select(id) {
	document.getElementById("listForm").id.value = id;
   	document.getElementById("listForm").action = "<c:url value='/mdUserDefinedDataTypes/updateMdUserDefinedDataTypesView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/mdUserDefinedDataTypes/addMdUserDefinedDataTypesView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/mdUserDefinedDataTypes/MdUserDefinedDataTypesList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								...
								<th align="center">Schema to which this object blongs. //PARENTFIELD</th>
								<th align="center">The name of the data type //OBJECTNAME</th>
								<th align="center">The definition of the data type</th>
								<th align="center">The native SQL used to create this object</th>
								<th align="center">An unique identifier for this object at source.</th>
			...
			<tr>
												...
												<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.id}"/>')"><c:out value="${result.id}"/></a>&nbsp;</td>
																...
																<td align="center" class="listtd"><c:out value="${result.dataTypeName}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.definition}"/>&nbsp;</td>
