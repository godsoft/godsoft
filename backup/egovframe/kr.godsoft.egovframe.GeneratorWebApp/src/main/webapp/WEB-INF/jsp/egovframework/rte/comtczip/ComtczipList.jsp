...
<%
 /**
  * @Class Name : ComtczipList.jsp
  * @Description : Comtczip List 화면
...
<title>comtczip 목록</title>
<link type="text/css" rel="stylesheet" href="<c:url value='/css/egovframework/sample.css'/>"/>
<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 수정 화면 function */
function fn_egov_select(zip, sn) {
	document.getElementById("listForm").zip.value = zip;
	document.getElementById("listForm").sn.value = sn;
   	document.getElementById("listForm").action = "<c:url value='/comtczip/updateComtczipView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/comtczip/addComtczipView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/comtczip/ComtczipList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								...
								<th align="center">li_buld_nm</th>
								<th align="center">lnbr_dong_ho</th>
			...
			<tr>
												...
												<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.zip}"/>', '<c:out value="${result.sn}"/>')"><c:out value="${result.zip}"/></a>&nbsp;</td>
																...
																<td align="center" class="listtd"><c:out value="${result.liBuldNm}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.lnbrDongHo}"/>&nbsp;</td>
