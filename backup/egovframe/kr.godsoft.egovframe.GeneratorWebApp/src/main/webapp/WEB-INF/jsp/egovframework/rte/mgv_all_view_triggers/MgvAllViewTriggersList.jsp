...
<%
 /**
  * @Class Name : MgvAllViewTriggersList.jsp
  * @Description : MgvAllViewTriggers List 화면
...
<title>mgv_all_view_triggers 목록</title>
<link type="text/css" rel="stylesheet" href="<c:url value='/css/egovframework/sample.css'/>"/>
<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 수정 화면 function */
function fn_egov_select() {
   	document.getElementById("listForm").action = "<c:url value='/mgvAllViewTriggers/updateMgvAllViewTriggersView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/mgvAllViewTriggers/addMgvAllViewTriggersView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/mgvAllViewTriggers/MgvAllViewTriggersList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								...
								<th align="center">dummy_flag</th>
								<th align="center">schema_id</th>
								<th align="center">schema_name</th>
								<th align="center">view_id</th>
								<th align="center">view_name</th>
								<th align="center">trigger_id</th>
								<th align="center">trigger_name</th>
							</tr>
			...
			<tr>
												...
												<td align="center" class="listtd"><c:out value="${result.projectId}"/>&nbsp;</td>
																...
																<td align="center" class="listtd"><c:out value="${result.viewId}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.viewName}"/>&nbsp;</td>
																<td align="center" class="listtd"><c:out value="${result.triggerId}"/>&nbsp;</td>
