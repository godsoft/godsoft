...
<c:set var="registerFlag" value="${empty comtnrssVO.rssId ? '등록' : '수정'}"/>
<title>comtnrss <c:out value="${registerFlag}"/> </title>
...
<form:form commandName="comtnrssVO" name="detailForm" id="detailForm">
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
