...
<%
 /**
  * @Class Name : ComtnnoterecptnRegister.jsp
  * @Description : Comtnnoterecptn Register 화면
...
<!-- validator:javascript formName="comtnnoterecptnVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/comtnnoterecptn/ComtnnoterecptnList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/comtnnoterecptn/deleteComtnnoterecptn.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/comtnnoterecptn/addComtnnoterecptn.do' : '/comtnnoterecptn/updateComtnnoterecptn.do'}"/>";
    frm.submit();
...
<form:form commandName="comtnnoterecptnVO" name="detailForm" id="detailForm">
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
