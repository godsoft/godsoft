...
<%
 /**
  * @Class Name : MdGroupPrivilegesList.jsp
  * @Description : MdGroupPrivileges List 화면
...
<title>This table stores the privileges granted to a group (or role) 목록</title>
...
function fn_egov_select(id) {
	document.getElementById("listForm").id.value = id;
   	document.getElementById("listForm").action = "<c:url value='/mdGroupPrivileges/updateMdGroupPrivilegesView.do'/>";
   	document.getElementById("listForm").submit();		
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/mdGroupPrivileges/addMdGroupPrivilegesView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/mdGroupPrivileges/MdGroupPrivilegesList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								...
								<th align="center">privilege_id_fk</th>
