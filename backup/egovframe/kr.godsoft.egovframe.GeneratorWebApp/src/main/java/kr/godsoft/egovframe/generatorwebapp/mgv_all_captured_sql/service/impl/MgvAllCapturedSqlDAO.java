...
/**
 * @Class Name : MgvAllCapturedSqlDAO.java
 * @Description : MgvAllCapturedSql DAO Class
...
@Repository("mgvAllCapturedSqlDAO")
public class MgvAllCapturedSqlDAO extends EgovAbstractDAO {
    ...
    public String insertMgvAllCapturedSql(MgvAllCapturedSqlVO vo) throws Exception {
        return (String)insert("mgvAllCapturedSqlDAO.insertMgvAllCapturedSql_S", vo);
    }
    ...
    public void updateMgvAllCapturedSql(MgvAllCapturedSqlVO vo) throws Exception {
        update("mgvAllCapturedSqlDAO.updateMgvAllCapturedSql_S", vo);
    }
    ...
    public void deleteMgvAllCapturedSql(MgvAllCapturedSqlVO vo) throws Exception {
        delete("mgvAllCapturedSqlDAO.deleteMgvAllCapturedSql_S", vo);
    }
    ...
    public MgvAllCapturedSqlVO selectMgvAllCapturedSql(MgvAllCapturedSqlVO vo) throws Exception {
        return (MgvAllCapturedSqlVO) selectByPk("mgvAllCapturedSqlDAO.selectMgvAllCapturedSql_S", vo);
    }
    ...
    public List<EgovMap> selectMgvAllCapturedSqlList(MgvAllCapturedSqlVO vo) throws Exception {
        return list("mgvAllCapturedSqlDAO.selectMgvAllCapturedSqlList_D", vo);
    }
    ...
    public int selectMgvAllCapturedSqlListTotCnt(MgvAllCapturedSqlVO vo) {
        return (Integer)getSqlMapClientTemplate().queryForObject("mgvAllCapturedSqlDAO.selectMgvAllCapturedSqlListTotCnt_S", vo);
    }
