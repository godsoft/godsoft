...
public class MgvAllStoredProgramsController {
    ...
    public String selectMgvAllStoredProgramsList(@ModelAttribute("searchVO") MgvAllStoredProgramsVO searchVO, 
    		ModelMap model)
            throws Exception {
    ...
    public String addMgvAllStoredProgramsView(
            @ModelAttribute("searchVO") MgvAllStoredProgramsDefaultVO searchVO, Model model)
            throws Exception {
    ...
    public String addMgvAllStoredPrograms(
            MgvAllStoredProgramsVO mgvAllStoredProgramsVO,
            @ModelAttribute("searchVO") MgvAllStoredProgramsDefaultVO searchVO, SessionStatus status)
            throws Exception {
    ...
    public String updateMgvAllStoredProgramsView(
            @ModelAttribute("searchVO") MgvAllStoredProgramsDefaultVO searchVO, Model model)
            throws Exception {
        MgvAllStoredProgramsVO mgvAllStoredProgramsVO = new MgvAllStoredProgramsVO();
;        
        // 변수명은 CoC 에 따라 mgvAllStoredProgramsVO
    ...
    public @ModelAttribute("mgvAllStoredProgramsVO")
    MgvAllStoredProgramsVO selectMgvAllStoredPrograms(
            MgvAllStoredProgramsVO mgvAllStoredProgramsVO,
            @ModelAttribute("searchVO") MgvAllStoredProgramsDefaultVO searchVO) throws Exception {
    ...
    public String updateMgvAllStoredPrograms(
            MgvAllStoredProgramsVO mgvAllStoredProgramsVO,
            @ModelAttribute("searchVO") MgvAllStoredProgramsDefaultVO searchVO, SessionStatus status)
            throws Exception {
    ...
    public String deleteMgvAllStoredPrograms(
            MgvAllStoredProgramsVO mgvAllStoredProgramsVO,
            @ModelAttribute("searchVO") MgvAllStoredProgramsDefaultVO searchVO, SessionStatus status)
            throws Exception {
