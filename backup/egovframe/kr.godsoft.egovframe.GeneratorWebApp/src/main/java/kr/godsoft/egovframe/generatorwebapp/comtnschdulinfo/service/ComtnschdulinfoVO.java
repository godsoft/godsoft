 ...
 * @Description : Comtnschdulinfo VO class
...
public class ComtnschdulinfoVO extends ComtnschdulinfoDefaultVO {
    ...
    public String getSchdulKndCode() {
        return this.schdulKndCode;
    }
    
    public void setSchdulKndCode(String schdulKndCode) {
