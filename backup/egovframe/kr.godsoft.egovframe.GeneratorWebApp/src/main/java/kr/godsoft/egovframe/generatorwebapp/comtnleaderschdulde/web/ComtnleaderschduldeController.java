...
public class ComtnleaderschduldeController {
	 ...
	 * @param searchVO - 조회할 정보가 담긴 ComtnleaderschduldeVO
	 * @return "/comtnleaderschdulde/ComtnleaderschduldeList"
	 * @exception Exception
	 */
    @RequestMapping(value="/comtnleaderschdulde/ComtnleaderschduldeList.do")
    public String selectComtnleaderschduldeList(@ModelAttribute("searchVO") ComtnleaderschduldeVO searchVO, 
    		ModelMap model)
            throws Exception {
        ...
        List<EgovMap> comtnleaderschduldeList = comtnleaderschduldeService.selectComtnleaderschduldeList(searchVO);
