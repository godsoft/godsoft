...
/**
 * @Class Name : MdMigrParameterDAO.java
 * @Description : MdMigrParameter DAO Class
...
@Repository("mdMigrParameterDAO")
public class MdMigrParameterDAO extends EgovAbstractDAO {
    ...
    public String insertMdMigrParameter(MdMigrParameterVO vo) throws Exception {
        return (String)insert("mdMigrParameterDAO.insertMdMigrParameter_S", vo);
    }
    ...
    public void updateMdMigrParameter(MdMigrParameterVO vo) throws Exception {
        update("mdMigrParameterDAO.updateMdMigrParameter_S", vo);
    }
    ...
    public void deleteMdMigrParameter(MdMigrParameterVO vo) throws Exception {
        delete("mdMigrParameterDAO.deleteMdMigrParameter_S", vo);
    }
    ...
    public MdMigrParameterVO selectMdMigrParameter(MdMigrParameterVO vo) throws Exception {
        return (MdMigrParameterVO) selectByPk("mdMigrParameterDAO.selectMdMigrParameter_S", vo);
    }
    ...
    public List<EgovMap> selectMdMigrParameterList(MdMigrParameterVO vo) throws Exception {
        return list("mdMigrParameterDAO.selectMdMigrParameterList_D", vo);
    }
    ...
    public int selectMdMigrParameterListTotCnt(MdMigrParameterVO vo) {
        return (Integer)getSqlMapClientTemplate().queryForObject("mdMigrParameterDAO.selectMdMigrParameterListTotCnt_S", vo);
    }
