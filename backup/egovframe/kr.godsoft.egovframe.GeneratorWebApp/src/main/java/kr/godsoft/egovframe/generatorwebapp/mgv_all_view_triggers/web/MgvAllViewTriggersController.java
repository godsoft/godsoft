...
public class MgvAllViewTriggersController {
    ...
    public String selectMgvAllViewTriggersList(@ModelAttribute("searchVO") MgvAllViewTriggersVO searchVO, 
    		ModelMap model)
            throws Exception {
    ...
    public String addMgvAllViewTriggersView(
            @ModelAttribute("searchVO") MgvAllViewTriggersDefaultVO searchVO, Model model)
            throws Exception {
    ...
    public String addMgvAllViewTriggers(
            MgvAllViewTriggersVO mgvAllViewTriggersVO,
            @ModelAttribute("searchVO") MgvAllViewTriggersDefaultVO searchVO, SessionStatus status)
            throws Exception {
    ...
    public String updateMgvAllViewTriggersView(
            @ModelAttribute("searchVO") MgvAllViewTriggersDefaultVO searchVO, Model model)
            throws Exception {
        MgvAllViewTriggersVO mgvAllViewTriggersVO = new MgvAllViewTriggersVO();
;        
        // 변수명은 CoC 에 따라 mgvAllViewTriggersVO
    ...
    public @ModelAttribute("mgvAllViewTriggersVO")
    MgvAllViewTriggersVO selectMgvAllViewTriggers(
            MgvAllViewTriggersVO mgvAllViewTriggersVO,
            @ModelAttribute("searchVO") MgvAllViewTriggersDefaultVO searchVO) throws Exception {
    ...
    public String updateMgvAllViewTriggers(
            MgvAllViewTriggersVO mgvAllViewTriggersVO,
            @ModelAttribute("searchVO") MgvAllViewTriggersDefaultVO searchVO, SessionStatus status)
            throws Exception {
    ...
    public String deleteMgvAllViewTriggers(
            MgvAllViewTriggersVO mgvAllViewTriggersVO,
            @ModelAttribute("searchVO") MgvAllViewTriggersDefaultVO searchVO, SessionStatus status)
            throws Exception {
