...
<%
 /**
  * @Class Name : ComtssyslogsummaryRegister.jsp
  * @Description : Comtssyslogsummary Register 화면
...
<!-- validator:javascript formName="comtssyslogsummaryVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
    document.getElementById("detailForm").action = "<c:url value='/comtssyslogsummary/selectComtssyslogsummaryList.do'/>";
...
function fn_egov_delete() {
    document.getElementById("detailForm").action = "<c:url value='/comtssyslogsummary/deleteComtssyslogsummary.do'/>";
    document.getElementById("detailForm").submit();
}
...
function fn_egov_save() {
    ...
    form.action = "<c:url value="${registerFlag == '등록' ? '/comtssyslogsummary/addComtssyslogsummary.do' : '/comtssyslogsummary/updateComtssyslogsummary.do'}"/>";
    form.submit();
}
//-->
</script>
