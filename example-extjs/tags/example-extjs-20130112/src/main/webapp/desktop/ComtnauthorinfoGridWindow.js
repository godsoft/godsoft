...
Ext
        .define(
                'MyDesktop.ComtnauthorinfoGridWindow',
                {
                    ...
                    id : 'grid-win-comtnauthorinfo',

                    init : function() {
                        this.launcher = {
                            text : 'Comtnauthorinfo Grid Window',
                            iconCls : 'icon-grid'
                        };
                    },
                    ...
                    createWindow : function() {
                        ...
                        var win = desktop.getWindow('grid-win-comtnauthorinfo');
                        if (!win) {
                            ...
                            var myStore = Ext
                                    .create(
                                            'Ext.data.Store',
                                            {
                                                ...
                                                proxy : {
                                                    type : 'ajax',
                                                    url : '/example-extjs/comtnauthorinfo/selectComtnauthorinfoListJson.do',
                                                    reader : {
                                                        type : 'json',
                                                        root : 'resultList'
                                                    }
                            ...
                            win = desktop.createWindow({
                                id : 'grid-win-comtnauthorinfo',
                                title : 'Comtnauthorinfo Grid Window',
                                width : 740,
                                height : 480,
                                iconCls : 'icon-grid',
                                animCollapse : false,
