...
Ext
        .define(
                'MyDesktop.ComtnuserlogGridWindow',
                {
                    ...
                    id : 'grid-win-comtnuserlog',

                    init : function() {
                        this.launcher = {
                            text : 'Comtnuserlog Grid Window',
                            iconCls : 'icon-grid'
                        };
                    },
                    ...
                    createWindow : function() {
                        ...
                        var win = desktop.getWindow('grid-win-comtnuserlog');
                        if (!win) {
                            ...
                            var myStore = Ext
                                    .create(
                                            'Ext.data.Store',
                                            {
                                                ...
                                                proxy : {
                                                    type : 'ajax',
                                                    url : '/example-extjs/comtnuserlog/selectComtnuserlogListJson.do',
                                                    reader : {
                                                        type : 'json',
                                                        root : 'resultList'
                                                    }
                            ...
                            win = desktop.createWindow({
                                id : 'grid-win-comtnuserlog',
                                title : 'Comtnuserlog Grid Window',
                                width : 740,
                                height : 480,
                                iconCls : 'icon-grid',
                                animCollapse : false,
