...
public interface ComtnprogrmlistService {
     ...
     * @exception Exception
     */
    int updateComtnprogrmlist(ComtnprogrmlistVO vo) throws Exception;
     ...
     * @exception Exception
     */
    int deleteComtnprogrmlist(ComtnprogrmlistVO vo) throws Exception;
     ...
     * @exception Exception
     */
    List<EgovMap> selectComtnprogrmlistList(ComtnprogrmlistDefaultVO searchVO) throws Exception;
     ...
     * @exception
     */
    int selectComtnprogrmlistListTotCnt(ComtnprogrmlistDefaultVO searchVO);
