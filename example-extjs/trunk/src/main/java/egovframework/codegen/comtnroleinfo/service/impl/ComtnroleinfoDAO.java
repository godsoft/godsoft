package egovframework.codegen.comtnroleinfo.service.impl;
...
public class ComtnroleinfoDAO extends EgovAbstractDAO {
     ...
     * @exception Exception
     */
    public int updateComtnroleinfo(ComtnroleinfoVO vo) throws Exception {
        return update("comtnroleinfoDAO.updateComtnroleinfo_S", vo);
    }
     ...
     * @exception Exception
     */
    public int deleteComtnroleinfo(ComtnroleinfoVO vo) throws Exception {
        return delete("comtnroleinfoDAO.deleteComtnroleinfo_S", vo);
    }
    ...
    public List<EgovMap> selectComtnroleinfoList(ComtnroleinfoDefaultVO searchVO) throws Exception {
    ...
    public int selectComtnroleinfoListTotCnt(ComtnroleinfoDefaultVO searchVO) {
        return (Integer) getSqlMapClientTemplate().queryForObject("comtnroleinfoDAO.selectComtnroleinfoListTotCnt_S", searchVO);
    }
