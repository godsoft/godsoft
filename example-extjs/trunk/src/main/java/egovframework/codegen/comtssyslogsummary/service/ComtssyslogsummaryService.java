...
public interface ComtssyslogsummaryService {
     ...
     * @exception Exception
     */
    int updateComtssyslogsummary(ComtssyslogsummaryVO vo) throws Exception;
     ...
     * @exception Exception
     */
    int deleteComtssyslogsummary(ComtssyslogsummaryVO vo) throws Exception;
     ...
     * @exception Exception
     */
    List<EgovMap> selectComtssyslogsummaryList(ComtssyslogsummaryDefaultVO searchVO) throws Exception;
