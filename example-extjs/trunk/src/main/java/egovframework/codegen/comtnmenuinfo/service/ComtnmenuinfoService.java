...
public interface ComtnmenuinfoService {
     ...
     * @exception Exception
     */
    int updateComtnmenuinfo(ComtnmenuinfoVO vo) throws Exception;
     ...
     * @exception Exception
     */
    int deleteComtnmenuinfo(ComtnmenuinfoVO vo) throws Exception;
     ...
     * @exception Exception
     */
    List<EgovMap> selectComtnmenuinfoList(ComtnmenuinfoDefaultVO searchVO) throws Exception;
