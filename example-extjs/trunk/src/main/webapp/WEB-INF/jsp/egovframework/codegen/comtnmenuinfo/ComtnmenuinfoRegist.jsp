...
<%
 /**
  * @Class Name : ComtnmenuinfoRegister.jsp
  * @Description : Comtnmenuinfo Register 화면
...
<c:set var="registerFlag" value="${empty comtnmenuinfoVO.id ? '등록' : '수정'}"/>
<title> <c:out value="${registerFlag}"/> </title>
<link type="text/css" rel="stylesheet" href="<c:url value='/css/egovframework/sample.css'/>"/>

<!--For Commons Validator Client Side-->
<!-- script type="text/javascript" src="<c:url value='/cmmn/validator.do'/>"></script -->
<!-- validator:javascript formName="comtnmenuinfoVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
    document.getElementById("detailForm").action = "<c:url value='/comtnmenuinfo/selectComtnmenuinfoList.do'/>";
...
function fn_egov_delete() {
    document.getElementById("detailForm").action = "<c:url value='/comtnmenuinfo/deleteComtnmenuinfo.do'/>";
    document.getElementById("detailForm").submit();
}
...
function fn_egov_save() {
    ...
    form.action = "<c:url value="${registerFlag == '등록' ? '/comtnmenuinfo/addComtnmenuinfo.do' : '/comtnmenuinfo/updateComtnmenuinfo.do'}"/>";
    form.submit();
}
//-->
</script>
...
<form:form commandName="comtnmenuinfoVO" name="detailForm" id="detailForm">
<div id="content_pop">
    <!-- 타이틀 -->
    <div id="title">
        <ul>
