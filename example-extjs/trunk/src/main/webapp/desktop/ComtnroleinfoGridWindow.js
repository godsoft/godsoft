...
Ext
        .define(
                'MyDesktop.ComtnroleinfoGridWindow',
                {
                    ...
                    id : 'grid-win-comtnroleinfo',

                    init : function() {
                        this.launcher = {
                            text : 'Comtnroleinfo Grid Window',
                            iconCls : 'icon-grid'
                        };
                    },
                    ...
                    createWindow : function() {
                        ...
                        var win = desktop.getWindow('grid-win-comtnroleinfo');
                        if (!win) {
                            ...
                            var myStore = Ext
                                    .create(
                                            'Ext.data.Store',
                                            {
                                                ...
                                                proxy : {
                                                    type : 'ajax',
                                                    url : '/example-extjs/comtnroleinfo/selectComtnroleinfoListJson.do',
                                                    reader : {
                                                        type : 'json',
                                                        root : 'resultList'
                                                    }
                            ...
                            win = desktop.createWindow({
                                id : 'grid-win-comtnroleinfo',
                                title : 'Comtnroleinfo Grid Window',
                                width : 740,
                                height : 480,
                                iconCls : 'icon-grid',
                                animCollapse : false,
