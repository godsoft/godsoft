...
Ext
        .define(
                'MyDesktop.ComtnmenuinfoGridWindow',
                {
                    ...
                    id : 'grid-win-comtnmenuinfo',

                    init : function() {
                        this.launcher = {
                            text : 'Comtnmenuinfo Grid Window',
                            iconCls : 'icon-grid'
                        };
                    },
                    ...
                    createWindow : function() {
                        ...
                        var win = desktop.getWindow('grid-win-comtnmenuinfo');
                        if (!win) {
                            ...
                            var myStore = Ext
                                    .create(
                                            'Ext.data.Store',
                                            {
                                                ...
                                                proxy : {
                                                    type : 'ajax',
                                                    url : '/example-extjs/comtnmenuinfo/selectComtnmenuinfoListJson.do',
                                                    reader : {
                                                        type : 'json',
                                                        root : 'resultList'
                                                    }
                            ...
                            win = desktop.createWindow({
                                id : 'grid-win-comtnmenuinfo',
                                title : 'Comtnmenuinfo Grid Window',
                                width : 740,
                                height : 480,
                                iconCls : 'icon-grid',
                                animCollapse : false,
...
//                                        renderer : Ext.util.Format.usMoney,
                                    ...
                                    {
                                        text : "relateImagePath",
//                                        width : 70,
                                        sortable : true,
//                                        renderer : Ext.util.Format.usMoney,
                                        dataIndex : 'relateImagePath'
                                    },
