...
Ext
        .define(
                'MyDesktop.ComtnprogrmlistGridWindow',
                {
                    ...
                    id : 'grid-win-comtnprogrmlist',

                    init : function() {
                        this.launcher = {
                            text : 'Comtnprogrmlist Grid Window',
                            iconCls : 'icon-grid'
                        };
                    },
                    ...
                    createWindow : function() {
                        ...
                        var win = desktop.getWindow('grid-win-comtnprogrmlist');
                        if (!win) {
                            ...
                            var myStore = Ext
                                    .create(
                                            'Ext.data.Store',
                                            {
                                                ...
                                                proxy : {
                                                    type : 'ajax',
                                                    url : '/example-extjs/comtnprogrmlist/selectComtnprogrmlistListJson.do',
                                                    reader : {
                                                        type : 'json',
                                                        root : 'resultList'
                                                    }
                            ...
                            win = desktop.createWindow({
                                id : 'grid-win-comtnprogrmlist',
                                title : 'Comtnprogrmlist Grid Window',
                                width : 740,
                                height : 480,
                                iconCls : 'icon-grid',
                                animCollapse : false,
