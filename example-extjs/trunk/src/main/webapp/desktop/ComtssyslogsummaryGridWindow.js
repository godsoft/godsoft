...
Ext
        .define(
                'MyDesktop.ComtssyslogsummaryGridWindow',
                {
                    ...
                    id : 'grid-win-comtssyslogsummary',

                    init : function() {
                        this.launcher = {
                            text : 'Comtssyslogsummary Grid Window',
                            iconCls : 'icon-grid'
                        };
                    },
                    ...
                    createWindow : function() {
                        ...
                        var win = desktop.getWindow('grid-win-comtssyslogsummary');
                        if (!win) {
                            ...
                            var myStore = Ext
                                    .create(
                                            'Ext.data.Store',
                                            {
                                                ...
                                                proxy : {
                                                    type : 'ajax',
                                                    url : '/example-extjs/comtssyslogsummary/selectComtssyslogsummaryListJson.do',
                                                    reader : {
                                                        type : 'json',
                                                        root : 'resultList'
                                                    }
                            ...
                            win = desktop.createWindow({
                                id : 'grid-win-comtssyslogsummary',
                                title : 'Comtssyslogsummary Grid Window',
                                width : 740,
                                height : 480,
                                iconCls : 'icon-grid',
                                animCollapse : false,
