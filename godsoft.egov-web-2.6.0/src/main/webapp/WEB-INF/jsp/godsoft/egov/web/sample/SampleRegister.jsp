...
function fn_egov_selectList() {
   	document.detailForm.action = "<c:url value='/godsoft/egov/web/sample/selectSampleList.do'/>";
   	document.detailForm.submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.detailForm.action = "<c:url value='/godsoft/egov/web/sample/deleteSample.do'/>";
   	document.detailForm.submit();		
}
...
function fn_egov_save() {	
	...
	if(!validateSampleVO(frm)){
    	...
    	frm.action = "<c:url value="${registerFlag == '등록' ? '/godsoft/egov/web/sample/addSample.do' : '/godsoft/egov/web/sample/updateSample.do'}"/>";
        frm.submit();
    }
}
