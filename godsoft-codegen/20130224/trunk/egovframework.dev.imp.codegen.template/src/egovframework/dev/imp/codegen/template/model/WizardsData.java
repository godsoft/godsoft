...
public class WizardsData {
    ...
    public static WizardsData[] getTemplateLists() {
        ...
        IExtension[] extensions =
            Platform.getExtensionRegistry().getExtensionPoint(
                EgovCodeGenPlugin.PLUGIN_ID, "templateWizards").getExtensions();
        ...
        cachedWizardsData =
            (WizardsData[]) found.toArray(new WizardsData[found.size()]);
     ...
     * @return
     */
    private static WizardsData parseType(Bundle bundle, String installedPath, IConfigurationElement configElement,
            int ordinal) {
